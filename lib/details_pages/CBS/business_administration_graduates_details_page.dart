...
class _MyBusinessAdministrationGraduatesDetailsPageState extends State<MyBusinessAdministrationGraduatesDetailsPage> {
  ...
  initState(){
    ...
    _autoBio = businessAdministrationNotifier.currentBusinessAdministration.autoBio;
    _bestMoment = businessAdministrationNotifier.currentBusinessAdministration.bestMoment;
    _whyCourseOfStudy = businessAdministrationNotifier.currentBusinessAdministration.whyCourseOfStudy;
    _highSchool = businessAdministrationNotifier.currentBusinessAdministration.highSchool;
    _highSchoolGraduationYear = businessAdministrationNotifier.currentBusinessAdministration.highSchoolGraduationYear;
    _linkedIn = businessAdministrationNotifier.currentBusinessAdministration.linkedIn;
    _favouriteCourse = businessAdministrationNotifier.currentBusinessAdministration.favouriteCourse;
    _schoolExecutive = businessAdministrationNotifier.currentBusinessAdministration.schoolExecutive;
    _schoolExecutivePosition = businessAdministrationNotifier.currentBusinessAdministration.schoolExecutivePosition;
    _snapchat = businessAdministrationNotifier.currentBusinessAdministration.snapchat;
    _tikTok = businessAdministrationNotifier.currentBusinessAdministration.tikTok;
    _favSchoolActivity = businessAdministrationNotifier.currentBusinessAdministration.favSchoolActivity;
    _scpcExecutive = businessAdministrationNotifier.currentBusinessAdministration.scpcExecutive;
    _scpcExecutivePosition = businessAdministrationNotifier.currentBusinessAdministration.scpcExecutivePosition;
    _favouriteLocationOnCampus = businessAdministrationNotifier.currentBusinessAdministration.favouriteLocationOnCampus;
    _favoriteSportOnCampus = businessAdministrationNotifier.currentBusinessAdministration.favoriteSportOnCampus;
    _originState = businessAdministrationNotifier.currentBusinessAdministration.stateOfOrigin;
    _whatsNext = businessAdministrationNotifier.currentBusinessAdministration.whatsNext;
    _stateResiding = businessAdministrationNotifier.currentBusinessAdministration.whereYouReside;
    _bestMoment = businessAdministrationNotifier.currentBusinessAdministration.bestMoment;
    _dob = businessAdministrationNotifier.currentBusinessAdministration.dob;
    _email = businessAdministrationNotifier.currentBusinessAdministration.email;
    _facebook = businessAdministrationNotifier.currentBusinessAdministration.facebook;
    _hobbies = businessAdministrationNotifier.currentBusinessAdministration.hobbies;
