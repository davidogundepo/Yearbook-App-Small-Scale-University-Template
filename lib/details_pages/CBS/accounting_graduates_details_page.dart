...
late AccountingNotifier accountingNotifier;
...
class MyAccountingGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyAccountingGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyAccountingGraduatesDetailsPage> createState() => MyAccountingGraduatesDetailsPageState();
}

class MyAccountingGraduatesDetailsPageState extends State<MyAccountingGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    accountingNotifier = Provider.of<AccountingNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            accountingNotifier.currentAccounting.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: accountingNotifier.currentAccounting.image!,
                        fit: BoxFit.cover,
                  ...
                  message: accountingNotifier.currentAccounting.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              accountingNotifier.currentAccounting.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (accountingNotifier.currentAccounting.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    AccountingNotifier accountingNotifier = Provider.of<AccountingNotifier>(context, listen: false);

    _autoBio = accountingNotifier.currentAccounting.autoBio;
    _bestMoment = accountingNotifier.currentAccounting.bestMoment;
    _whyCourseOfStudy = accountingNotifier.currentAccounting.whyCourseOfStudy;
    _highSchool = accountingNotifier.currentAccounting.highSchool;
    _highSchoolGraduationYear = accountingNotifier.currentAccounting.highSchoolGraduationYear;
    _linkedIn = accountingNotifier.currentAccounting.linkedIn;
    _favouriteCourse = accountingNotifier.currentAccounting.favouriteCourse;
    _schoolExecutive = accountingNotifier.currentAccounting.schoolExecutive;
    _schoolExecutivePosition = accountingNotifier.currentAccounting.schoolExecutivePosition;
    _snapchat = accountingNotifier.currentAccounting.snapchat;
    _tikTok = accountingNotifier.currentAccounting.tikTok;
    _favSchoolActivity = accountingNotifier.currentAccounting.favSchoolActivity;
    _scpcExecutive = accountingNotifier.currentAccounting.scpcExecutive;
    _scpcExecutivePosition = accountingNotifier.currentAccounting.scpcExecutivePosition;
    _favouriteLocationOnCampus = accountingNotifier.currentAccounting.favouriteLocationOnCampus;
    _favoriteSportOnCampus = accountingNotifier.currentAccounting.favoriteSportOnCampus;
    _originState = accountingNotifier.currentAccounting.stateOfOrigin;
    _whatsNext = accountingNotifier.currentAccounting.whatsNext;
    _stateResiding = accountingNotifier.currentAccounting.whereYouReside;
    _bestMoment = accountingNotifier.currentAccounting.bestMoment;
    _dob = accountingNotifier.currentAccounting.dob;
    _email = accountingNotifier.currentAccounting.email;
    _facebook = accountingNotifier.currentAccounting.facebook;
    _hobbies = accountingNotifier.currentAccounting.hobbies;
    _instagram = accountingNotifier.currentAccounting.instagram;
    _myDropline = accountingNotifier.currentAccounting.myDropline;
    _name = accountingNotifier.currentAccounting.name;
    _nickname = accountingNotifier.currentAccounting.nickname!;
    _philosophy = accountingNotifier.currentAccounting.philosophy;
    _phone = accountingNotifier.currentAccounting.phone;
    _twitter = accountingNotifier.currentAccounting.twitter;
    _worstMoment = accountingNotifier.currentAccounting.worstMoment;
    _occupation = accountingNotifier.currentAccounting.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: accountingNotifier.currentAccounting.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
