...
late SociologyNotifier sociologyNotifier;
...
class MySociologyGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MySociologyGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MySociologyGraduatesDetailsPage> createState() => MySociologyGraduatesDetailsPageState();
}

class MySociologyGraduatesDetailsPageState extends State<MySociologyGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    sociologyNotifier = Provider.of<SociologyNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            sociologyNotifier.currentSociology.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: sociologyNotifier.currentSociology.image!,
                        fit: BoxFit.cover,
                  ...
                  message: sociologyNotifier.currentSociology.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              sociologyNotifier.currentSociology.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (sociologyNotifier.currentSociology.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    SociologyNotifier sociologyNotifier = Provider.of<SociologyNotifier>(context, listen: false);

    _autoBio = sociologyNotifier.currentSociology.autoBio;
    _bestMoment = sociologyNotifier.currentSociology.bestMoment;
    _whyCourseOfStudy = sociologyNotifier.currentSociology.whyCourseOfStudy;
    _highSchool = sociologyNotifier.currentSociology.highSchool;
    _highSchoolGraduationYear = sociologyNotifier.currentSociology.highSchoolGraduationYear;
    _linkedIn = sociologyNotifier.currentSociology.linkedIn;
    _favouriteCourse = sociologyNotifier.currentSociology.favouriteCourse;
    _schoolExecutive = sociologyNotifier.currentSociology.schoolExecutive;
    _schoolExecutivePosition = sociologyNotifier.currentSociology.schoolExecutivePosition;
    _snapchat = sociologyNotifier.currentSociology.snapchat;
    _tikTok = sociologyNotifier.currentSociology.tikTok;
    _favSchoolActivity = sociologyNotifier.currentSociology.favSchoolActivity;
    _scpcExecutive = sociologyNotifier.currentSociology.scpcExecutive;
    _scpcExecutivePosition = sociologyNotifier.currentSociology.scpcExecutivePosition;
    _favouriteLocationOnCampus = sociologyNotifier.currentSociology.favouriteLocationOnCampus;
    _favoriteSportOnCampus = sociologyNotifier.currentSociology.favoriteSportOnCampus;
    _originState = sociologyNotifier.currentSociology.stateOfOrigin;
    _whatsNext = sociologyNotifier.currentSociology.whatsNext;
    _stateResiding = sociologyNotifier.currentSociology.whereYouReside;
    _bestMoment = sociologyNotifier.currentSociology.bestMoment;
    _dob = sociologyNotifier.currentSociology.dob;
    _email = sociologyNotifier.currentSociology.email;
    _facebook = sociologyNotifier.currentSociology.facebook;
    _hobbies = sociologyNotifier.currentSociology.hobbies;
    _instagram = sociologyNotifier.currentSociology.instagram;
    _myDropline = sociologyNotifier.currentSociology.myDropline;
    _name = sociologyNotifier.currentSociology.name;
    _nickname = sociologyNotifier.currentSociology.nickname!;
    _philosophy = sociologyNotifier.currentSociology.philosophy;
    _phone = sociologyNotifier.currentSociology.phone;
    _twitter = sociologyNotifier.currentSociology.twitter;
    _worstMoment = sociologyNotifier.currentSociology.worstMoment;
    _occupation = sociologyNotifier.currentSociology.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: sociologyNotifier.currentSociology.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
