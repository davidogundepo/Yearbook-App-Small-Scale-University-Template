...
late MassCommunicationsNotifier massCommunicationsNotifier;
...
class MyMassCommunicationsGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyMassCommunicationsGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyMassCommunicationsGraduatesDetailsPage> createState() => MyMassCommunicationsGraduatesDetailsPageState();
}

class MyMassCommunicationsGraduatesDetailsPageState extends State<MyMassCommunicationsGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    massCommunicationsNotifier = Provider.of<MassCommunicationsNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            massCommunicationsNotifier.currentMassCommunications.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: massCommunicationsNotifier.currentMassCommunications.image!,
                        fit: BoxFit.cover,
                  ...
                  message: massCommunicationsNotifier.currentMassCommunications.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              massCommunicationsNotifier.currentMassCommunications.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (massCommunicationsNotifier.currentMassCommunications.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    MassCommunicationsNotifier massCommunicationsNotifier = Provider.of<MassCommunicationsNotifier>(context, listen: false);

    _autoBio = massCommunicationsNotifier.currentMassCommunications.autoBio;
    _bestMoment = massCommunicationsNotifier.currentMassCommunications.bestMoment;
    _whyCourseOfStudy = massCommunicationsNotifier.currentMassCommunications.whyCourseOfStudy;
    _highSchool = massCommunicationsNotifier.currentMassCommunications.highSchool;
    _highSchoolGraduationYear = massCommunicationsNotifier.currentMassCommunications.highSchoolGraduationYear;
    _linkedIn = massCommunicationsNotifier.currentMassCommunications.linkedIn;
    _favouriteCourse = massCommunicationsNotifier.currentMassCommunications.favouriteCourse;
    _schoolExecutive = massCommunicationsNotifier.currentMassCommunications.schoolExecutive;
    _schoolExecutivePosition = massCommunicationsNotifier.currentMassCommunications.schoolExecutivePosition;
    _snapchat = massCommunicationsNotifier.currentMassCommunications.snapchat;
    _tikTok = massCommunicationsNotifier.currentMassCommunications.tikTok;
    _favSchoolActivity = massCommunicationsNotifier.currentMassCommunications.favSchoolActivity;
    _scpcExecutive = massCommunicationsNotifier.currentMassCommunications.scpcExecutive;
    _scpcExecutivePosition = massCommunicationsNotifier.currentMassCommunications.scpcExecutivePosition;
    _favouriteLocationOnCampus = massCommunicationsNotifier.currentMassCommunications.favouriteLocationOnCampus;
    _favoriteSportOnCampus = massCommunicationsNotifier.currentMassCommunications.favoriteSportOnCampus;
    _originState = massCommunicationsNotifier.currentMassCommunications.stateOfOrigin;
    _whatsNext = massCommunicationsNotifier.currentMassCommunications.whatsNext;
    _stateResiding = massCommunicationsNotifier.currentMassCommunications.whereYouReside;
    _bestMoment = massCommunicationsNotifier.currentMassCommunications.bestMoment;
    _dob = massCommunicationsNotifier.currentMassCommunications.dob;
    _email = massCommunicationsNotifier.currentMassCommunications.email;
    _facebook = massCommunicationsNotifier.currentMassCommunications.facebook;
    _hobbies = massCommunicationsNotifier.currentMassCommunications.hobbies;
    _instagram = massCommunicationsNotifier.currentMassCommunications.instagram;
    _myDropline = massCommunicationsNotifier.currentMassCommunications.myDropline;
    _name = massCommunicationsNotifier.currentMassCommunications.name;
    _nickname = massCommunicationsNotifier.currentMassCommunications.nickname!;
    _philosophy = massCommunicationsNotifier.currentMassCommunications.philosophy;
    _phone = massCommunicationsNotifier.currentMassCommunications.phone;
    _twitter = massCommunicationsNotifier.currentMassCommunications.twitter;
    _worstMoment = massCommunicationsNotifier.currentMassCommunications.worstMoment;
    _occupation = massCommunicationsNotifier.currentMassCommunications.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: massCommunicationsNotifier.currentMassCommunications.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
