...
late InternationalRelationsNotifier internationalRelationsNotifier;
...
class MyInternationalRelationsGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyInternationalRelationsGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyInternationalRelationsGraduatesDetailsPage> createState() => MyInternationalRelationsGraduatesDetailsPageState();
}

class MyInternationalRelationsGraduatesDetailsPageState extends State<MyInternationalRelationsGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    internationalRelationsNotifier = Provider.of<InternationalRelationsNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            internationalRelationsNotifier.currentInternationalRelations.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: internationalRelationsNotifier.currentInternationalRelations.image!,
                        fit: BoxFit.cover,
                  ...
                  message: internationalRelationsNotifier.currentInternationalRelations.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              internationalRelationsNotifier.currentInternationalRelations.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (internationalRelationsNotifier.currentInternationalRelations.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    _autoBio = internationalRelationsNotifier.currentInternationalRelations.autoBio;
    _bestMoment = internationalRelationsNotifier.currentInternationalRelations.bestMoment;
    _whyCourseOfStudy = internationalRelationsNotifier.currentInternationalRelations.whyCourseOfStudy;
    _highSchool = internationalRelationsNotifier.currentInternationalRelations.highSchool;
    _highSchoolGraduationYear = internationalRelationsNotifier.currentInternationalRelations.highSchoolGraduationYear;
    _linkedIn = internationalRelationsNotifier.currentInternationalRelations.linkedIn;
    _favouriteCourse = internationalRelationsNotifier.currentInternationalRelations.favouriteCourse;
    _schoolExecutive = internationalRelationsNotifier.currentInternationalRelations.schoolExecutive;
    _schoolExecutivePosition = internationalRelationsNotifier.currentInternationalRelations.schoolExecutivePosition;
    _snapchat = internationalRelationsNotifier.currentInternationalRelations.snapchat;
    _tikTok = internationalRelationsNotifier.currentInternationalRelations.tikTok;
    _favSchoolActivity = internationalRelationsNotifier.currentInternationalRelations.favSchoolActivity;
    _scpcExecutive = internationalRelationsNotifier.currentInternationalRelations.scpcExecutive;
    _scpcExecutivePosition = internationalRelationsNotifier.currentInternationalRelations.scpcExecutivePosition;
    _favouriteLocationOnCampus = internationalRelationsNotifier.currentInternationalRelations.favouriteLocationOnCampus;
    _favoriteSportOnCampus = internationalRelationsNotifier.currentInternationalRelations.favoriteSportOnCampus;
    _originState = internationalRelationsNotifier.currentInternationalRelations.stateOfOrigin;
    _whatsNext = internationalRelationsNotifier.currentInternationalRelations.whatsNext;
    _stateResiding = internationalRelationsNotifier.currentInternationalRelations.whereYouReside;
    _bestMoment = internationalRelationsNotifier.currentInternationalRelations.bestMoment;
    _dob = internationalRelationsNotifier.currentInternationalRelations.dob;
    _email = internationalRelationsNotifier.currentInternationalRelations.email;
    _facebook = internationalRelationsNotifier.currentInternationalRelations.facebook;
    _hobbies = internationalRelationsNotifier.currentInternationalRelations.hobbies;
    _instagram = internationalRelationsNotifier.currentInternationalRelations.instagram;
    _myDropline = internationalRelationsNotifier.currentInternationalRelations.myDropline;
    _name = internationalRelationsNotifier.currentInternationalRelations.name;
    _nickname = internationalRelationsNotifier.currentInternationalRelations.nickname!;
    _philosophy = internationalRelationsNotifier.currentInternationalRelations.philosophy;
    _phone = internationalRelationsNotifier.currentInternationalRelations.phone;
    _twitter = internationalRelationsNotifier.currentInternationalRelations.twitter;
    _worstMoment = internationalRelationsNotifier.currentInternationalRelations.worstMoment;
    _occupation = internationalRelationsNotifier.currentInternationalRelations.occupation;
  ...
  Future<void> loadFormData() async {
    ...
    try {
      ...
      if (kDebugMode) {print('Error loading form data: $e');
      }
    }
  }
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: internationalRelationsNotifier.currentInternationalRelations.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
