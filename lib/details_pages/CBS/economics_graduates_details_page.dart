...
late EconomicsNotifier economicsNotifier;
...
class MyEconomicsGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyEconomicsGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyEconomicsGraduatesDetailsPage> createState() => MyEconomicsGraduatesDetailsPageState();
}

class MyEconomicsGraduatesDetailsPageState extends State<MyEconomicsGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    economicsNotifier = Provider.of<EconomicsNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            economicsNotifier.currentEconomics.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: economicsNotifier.currentEconomics.image!,
                        fit: BoxFit.cover,
                  ...
                  message: economicsNotifier.currentEconomics.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              economicsNotifier.currentEconomics.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (economicsNotifier.currentEconomics.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    EconomicsNotifier economicsNotifier = Provider.of<EconomicsNotifier>(context, listen: false);

    _autoBio = economicsNotifier.currentEconomics.autoBio;
    _bestMoment = economicsNotifier.currentEconomics.bestMoment;
    _whyCourseOfStudy = economicsNotifier.currentEconomics.whyCourseOfStudy;
    _highSchool = economicsNotifier.currentEconomics.highSchool;
    _highSchoolGraduationYear = economicsNotifier.currentEconomics.highSchoolGraduationYear;
    _linkedIn = economicsNotifier.currentEconomics.linkedIn;
    _favouriteCourse = economicsNotifier.currentEconomics.favouriteCourse;
    _schoolExecutive = economicsNotifier.currentEconomics.schoolExecutive;
    _schoolExecutivePosition = economicsNotifier.currentEconomics.schoolExecutivePosition;
    _snapchat = economicsNotifier.currentEconomics.snapchat;
    _tikTok = economicsNotifier.currentEconomics.tikTok;
    _favSchoolActivity = economicsNotifier.currentEconomics.favSchoolActivity;
    _scpcExecutive = economicsNotifier.currentEconomics.scpcExecutive;
    _scpcExecutivePosition = economicsNotifier.currentEconomics.scpcExecutivePosition;
    _favouriteLocationOnCampus = economicsNotifier.currentEconomics.favouriteLocationOnCampus;
    _favoriteSportOnCampus = economicsNotifier.currentEconomics.favoriteSportOnCampus;
    _originState = economicsNotifier.currentEconomics.stateOfOrigin;
    _whatsNext = economicsNotifier.currentEconomics.whatsNext;
    _stateResiding = economicsNotifier.currentEconomics.whereYouReside;
    _bestMoment = economicsNotifier.currentEconomics.bestMoment;
    _dob = economicsNotifier.currentEconomics.dob;
    _email = economicsNotifier.currentEconomics.email;
    _facebook = economicsNotifier.currentEconomics.facebook;
    _hobbies = economicsNotifier.currentEconomics.hobbies;
    _instagram = economicsNotifier.currentEconomics.instagram;
    _myDropline = economicsNotifier.currentEconomics.myDropline;
    _name = economicsNotifier.currentEconomics.name;
    _nickname = economicsNotifier.currentEconomics.nickname!;
    _philosophy = economicsNotifier.currentEconomics.philosophy;
    _phone = economicsNotifier.currentEconomics.phone;
    _twitter = economicsNotifier.currentEconomics.twitter;
    _worstMoment = economicsNotifier.currentEconomics.worstMoment;
    _occupation = economicsNotifier.currentEconomics.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: economicsNotifier.currentEconomics.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
