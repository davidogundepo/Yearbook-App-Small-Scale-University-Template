...
late BankingAndFinanceNotifier bankingAndFinanceNotifier;
...
class MyBankingAndFinanceGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyBankingAndFinanceGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyBankingAndFinanceGraduatesDetailsPage> createState() => MyBankingAndFinanceGraduatesDetailsPageState();
}

class MyBankingAndFinanceGraduatesDetailsPageState extends State<MyBankingAndFinanceGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    bankingAndFinanceNotifier = Provider.of<BankingAndFinanceNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            bankingAndFinanceNotifier.currentBankingAndFinance.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: bankingAndFinanceNotifier.currentBankingAndFinance.image!,
                        fit: BoxFit.cover,
                  ...
                  message: bankingAndFinanceNotifier.currentBankingAndFinance.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              bankingAndFinanceNotifier.currentBankingAndFinance.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (bankingAndFinanceNotifier.currentBankingAndFinance.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    _autoBio = bankingAndFinanceNotifier.currentBankingAndFinance.autoBio;
    _bestMoment = bankingAndFinanceNotifier.currentBankingAndFinance.bestMoment;
    _whyCourseOfStudy = bankingAndFinanceNotifier.currentBankingAndFinance.whyCourseOfStudy;
    _highSchool = bankingAndFinanceNotifier.currentBankingAndFinance.highSchool;
    _highSchoolGraduationYear = bankingAndFinanceNotifier.currentBankingAndFinance.highSchoolGraduationYear;
    _linkedIn = bankingAndFinanceNotifier.currentBankingAndFinance.linkedIn;
    _favouriteCourse = bankingAndFinanceNotifier.currentBankingAndFinance.favouriteCourse;
    _schoolExecutive = bankingAndFinanceNotifier.currentBankingAndFinance.schoolExecutive;
    _schoolExecutivePosition = bankingAndFinanceNotifier.currentBankingAndFinance.schoolExecutivePosition;
    _snapchat = bankingAndFinanceNotifier.currentBankingAndFinance.snapchat;
    _tikTok = bankingAndFinanceNotifier.currentBankingAndFinance.tikTok;
    _favSchoolActivity = bankingAndFinanceNotifier.currentBankingAndFinance.favSchoolActivity;
    _scpcExecutive = bankingAndFinanceNotifier.currentBankingAndFinance.scpcExecutive;
    _scpcExecutivePosition = bankingAndFinanceNotifier.currentBankingAndFinance.scpcExecutivePosition;
    _favouriteLocationOnCampus = bankingAndFinanceNotifier.currentBankingAndFinance.favouriteLocationOnCampus;
    _favoriteSportOnCampus = bankingAndFinanceNotifier.currentBankingAndFinance.favoriteSportOnCampus;
    _originState = bankingAndFinanceNotifier.currentBankingAndFinance.stateOfOrigin;
    _whatsNext = bankingAndFinanceNotifier.currentBankingAndFinance.whatsNext;
    _stateResiding = bankingAndFinanceNotifier.currentBankingAndFinance.whereYouReside;
    _bestMoment = bankingAndFinanceNotifier.currentBankingAndFinance.bestMoment;
    _dob = bankingAndFinanceNotifier.currentBankingAndFinance.dob;
    _email = bankingAndFinanceNotifier.currentBankingAndFinance.email;
    _facebook = bankingAndFinanceNotifier.currentBankingAndFinance.facebook;
    _hobbies = bankingAndFinanceNotifier.currentBankingAndFinance.hobbies;
    _instagram = bankingAndFinanceNotifier.currentBankingAndFinance.instagram;
    _myDropline = bankingAndFinanceNotifier.currentBankingAndFinance.myDropline;
    _name = bankingAndFinanceNotifier.currentBankingAndFinance.name;
    _nickname = bankingAndFinanceNotifier.currentBankingAndFinance.nickname!;
    _philosophy = bankingAndFinanceNotifier.currentBankingAndFinance.philosophy;
    _phone = bankingAndFinanceNotifier.currentBankingAndFinance.phone;
    _twitter = bankingAndFinanceNotifier.currentBankingAndFinance.twitter;
    _worstMoment = bankingAndFinanceNotifier.currentBankingAndFinance.worstMoment;
    _occupation = bankingAndFinanceNotifier.currentBankingAndFinance.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: bankingAndFinanceNotifier.currentBankingAndFinance.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
