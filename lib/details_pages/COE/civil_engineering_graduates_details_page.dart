...
late CivilEngineeringNotifier civilEngineeringNotifier;
...
class MyCivilEngineeringGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyCivilEngineeringGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyCivilEngineeringGraduatesDetailsPage> createState() => MyCivilEngineeringGraduatesDetailsPageState();
}

class MyCivilEngineeringGraduatesDetailsPageState extends State<MyCivilEngineeringGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    civilEngineeringNotifier = Provider.of<CivilEngineeringNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            civilEngineeringNotifier.currentCivilEngineering.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: civilEngineeringNotifier.currentCivilEngineering.image!,
                        fit: BoxFit.cover,
                  ...
                  message: civilEngineeringNotifier.currentCivilEngineering.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              civilEngineeringNotifier.currentCivilEngineering.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (civilEngineeringNotifier.currentCivilEngineering.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    _autoBio = civilEngineeringNotifier.currentCivilEngineering.autoBio;
    _bestMoment = civilEngineeringNotifier.currentCivilEngineering.bestMoment;
    _whyCourseOfStudy = civilEngineeringNotifier.currentCivilEngineering.whyCourseOfStudy;
    _highSchool = civilEngineeringNotifier.currentCivilEngineering.highSchool;
    _highSchoolGraduationYear = civilEngineeringNotifier.currentCivilEngineering.highSchoolGraduationYear;
    _linkedIn = civilEngineeringNotifier.currentCivilEngineering.linkedIn;
    _favouriteCourse = civilEngineeringNotifier.currentCivilEngineering.favouriteCourse;
    _schoolExecutive = civilEngineeringNotifier.currentCivilEngineering.schoolExecutive;
    _schoolExecutivePosition = civilEngineeringNotifier.currentCivilEngineering.schoolExecutivePosition;
    _snapchat = civilEngineeringNotifier.currentCivilEngineering.snapchat;
    _tikTok = civilEngineeringNotifier.currentCivilEngineering.tikTok;
    _favSchoolActivity = civilEngineeringNotifier.currentCivilEngineering.favSchoolActivity;
    _scpcExecutive = civilEngineeringNotifier.currentCivilEngineering.scpcExecutive;
    _scpcExecutivePosition = civilEngineeringNotifier.currentCivilEngineering.scpcExecutivePosition;
    _favouriteLocationOnCampus = civilEngineeringNotifier.currentCivilEngineering.favouriteLocationOnCampus;
    _favoriteSportOnCampus = civilEngineeringNotifier.currentCivilEngineering.favoriteSportOnCampus;
    _originState = civilEngineeringNotifier.currentCivilEngineering.stateOfOrigin;
    _whatsNext = civilEngineeringNotifier.currentCivilEngineering.whatsNext;
    _stateResiding = civilEngineeringNotifier.currentCivilEngineering.whereYouReside;
    _bestMoment = civilEngineeringNotifier.currentCivilEngineering.bestMoment;
    _dob = civilEngineeringNotifier.currentCivilEngineering.dob;
    _email = civilEngineeringNotifier.currentCivilEngineering.email;
    _facebook = civilEngineeringNotifier.currentCivilEngineering.facebook;
    _hobbies = civilEngineeringNotifier.currentCivilEngineering.hobbies;
    _instagram = civilEngineeringNotifier.currentCivilEngineering.instagram;
    _myDropline = civilEngineeringNotifier.currentCivilEngineering.myDropline;
    _name = civilEngineeringNotifier.currentCivilEngineering.name;
    _nickname = civilEngineeringNotifier.currentCivilEngineering.nickname!;
    _philosophy = civilEngineeringNotifier.currentCivilEngineering.philosophy;
    _phone = civilEngineeringNotifier.currentCivilEngineering.phone;
    _twitter = civilEngineeringNotifier.currentCivilEngineering.twitter;
    _worstMoment = civilEngineeringNotifier.currentCivilEngineering.worstMoment;
    _occupation = civilEngineeringNotifier.currentCivilEngineering.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: civilEngineeringNotifier.currentCivilEngineering.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
