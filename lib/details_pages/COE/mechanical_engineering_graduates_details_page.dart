...
late MechanicalEngineeringNotifier mechanicalEngineeringNotifier;
...
class MyMechanicalEngineeringGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyMechanicalEngineeringGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyMechanicalEngineeringGraduatesDetailsPage> createState() => MyMechanicalEngineeringGraduatesDetailsPageState();
}

class MyMechanicalEngineeringGraduatesDetailsPageState extends State<MyMechanicalEngineeringGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    mechanicalEngineeringNotifier = Provider.of<MechanicalEngineeringNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            mechanicalEngineeringNotifier.currentMechanicalEngineering.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: mechanicalEngineeringNotifier.currentMechanicalEngineering.image!,
                        fit: BoxFit.cover,
                  ...
                  message: mechanicalEngineeringNotifier.currentMechanicalEngineering.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              mechanicalEngineeringNotifier.currentMechanicalEngineering.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (mechanicalEngineeringNotifier.currentMechanicalEngineering.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    MechanicalEngineeringNotifier mechanicalEngineeringNotifier = Provider.of<MechanicalEngineeringNotifier>(context, listen: false);

    _autoBio = mechanicalEngineeringNotifier.currentMechanicalEngineering.autoBio;
    _bestMoment = mechanicalEngineeringNotifier.currentMechanicalEngineering.bestMoment;
    _whyCourseOfStudy = mechanicalEngineeringNotifier.currentMechanicalEngineering.whyCourseOfStudy;
    _highSchool = mechanicalEngineeringNotifier.currentMechanicalEngineering.highSchool;
    _highSchoolGraduationYear = mechanicalEngineeringNotifier.currentMechanicalEngineering.highSchoolGraduationYear;
    _linkedIn = mechanicalEngineeringNotifier.currentMechanicalEngineering.linkedIn;
    _favouriteCourse = mechanicalEngineeringNotifier.currentMechanicalEngineering.favouriteCourse;
    _schoolExecutive = mechanicalEngineeringNotifier.currentMechanicalEngineering.schoolExecutive;
    _schoolExecutivePosition = mechanicalEngineeringNotifier.currentMechanicalEngineering.schoolExecutivePosition;
    _snapchat = mechanicalEngineeringNotifier.currentMechanicalEngineering.snapchat;
    _tikTok = mechanicalEngineeringNotifier.currentMechanicalEngineering.tikTok;
    _favSchoolActivity = mechanicalEngineeringNotifier.currentMechanicalEngineering.favSchoolActivity;
    _scpcExecutive = mechanicalEngineeringNotifier.currentMechanicalEngineering.scpcExecutive;
    _scpcExecutivePosition = mechanicalEngineeringNotifier.currentMechanicalEngineering.scpcExecutivePosition;
    _favouriteLocationOnCampus = mechanicalEngineeringNotifier.currentMechanicalEngineering.favouriteLocationOnCampus;
    _favoriteSportOnCampus = mechanicalEngineeringNotifier.currentMechanicalEngineering.favoriteSportOnCampus;
    _originState = mechanicalEngineeringNotifier.currentMechanicalEngineering.stateOfOrigin;
    _whatsNext = mechanicalEngineeringNotifier.currentMechanicalEngineering.whatsNext;
    _stateResiding = mechanicalEngineeringNotifier.currentMechanicalEngineering.whereYouReside;
    _bestMoment = mechanicalEngineeringNotifier.currentMechanicalEngineering.bestMoment;
    _dob = mechanicalEngineeringNotifier.currentMechanicalEngineering.dob;
    _email = mechanicalEngineeringNotifier.currentMechanicalEngineering.email;
    _facebook = mechanicalEngineeringNotifier.currentMechanicalEngineering.facebook;
    _hobbies = mechanicalEngineeringNotifier.currentMechanicalEngineering.hobbies;
    _instagram = mechanicalEngineeringNotifier.currentMechanicalEngineering.instagram;
    _myDropline = mechanicalEngineeringNotifier.currentMechanicalEngineering.myDropline;
    _name = mechanicalEngineeringNotifier.currentMechanicalEngineering.name;
    _nickname = mechanicalEngineeringNotifier.currentMechanicalEngineering.nickname!;
    _philosophy = mechanicalEngineeringNotifier.currentMechanicalEngineering.philosophy;
    _phone = mechanicalEngineeringNotifier.currentMechanicalEngineering.phone;
    _twitter = mechanicalEngineeringNotifier.currentMechanicalEngineering.twitter;
    _worstMoment = mechanicalEngineeringNotifier.currentMechanicalEngineering.worstMoment;
    _occupation = mechanicalEngineeringNotifier.currentMechanicalEngineering.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: mechanicalEngineeringNotifier.currentMechanicalEngineering.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
