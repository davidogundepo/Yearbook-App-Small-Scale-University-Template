...
late ElectricalAndInformationEngineeringNotifier electricalAndInformationEngineeringNotifier;
...
class MyElectricalAndInformationEngineeringGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyElectricalAndInformationEngineeringGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyElectricalAndInformationEngineeringGraduatesDetailsPage> createState() => MyElectricalAndInformationEngineeringGraduatesDetailsPageState();
}

class MyElectricalAndInformationEngineeringGraduatesDetailsPageState extends State<MyElectricalAndInformationEngineeringGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    electricalAndInformationEngineeringNotifier = Provider.of<ElectricalAndInformationEngineeringNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.image!,
                        fit: BoxFit.cover,
                  ...
                  message: electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    _autoBio = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.autoBio;
    _bestMoment = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.bestMoment;
    _whyCourseOfStudy = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.whyCourseOfStudy;
    _highSchool = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.highSchool;
    _highSchoolGraduationYear = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.highSchoolGraduationYear;
    _linkedIn = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.linkedIn;
    _favouriteCourse = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.favouriteCourse;
    _schoolExecutive = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.schoolExecutive;
    _schoolExecutivePosition = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.schoolExecutivePosition;
    _snapchat = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.snapchat;
    _tikTok = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.tikTok;
    _favSchoolActivity = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.favSchoolActivity;
    _scpcExecutive = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.scpcExecutive;
    _scpcExecutivePosition = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.scpcExecutivePosition;
    _favouriteLocationOnCampus = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.favouriteLocationOnCampus;
    _favoriteSportOnCampus = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.favoriteSportOnCampus;
    _originState = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.stateOfOrigin;
    _whatsNext = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.whatsNext;
    _stateResiding = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.whereYouReside;
    _bestMoment = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.bestMoment;
    _dob = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.dob;
    _email = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.email;
    _facebook = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.facebook;
    _hobbies = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.hobbies;
    _instagram = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.instagram;
    _myDropline = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.myDropline;
    _name = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.name;
    _nickname = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.nickname!;
    _philosophy = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.philosophy;
    _phone = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.phone;
    _twitter = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.twitter;
    _worstMoment = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.worstMoment;
    _occupation = electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
