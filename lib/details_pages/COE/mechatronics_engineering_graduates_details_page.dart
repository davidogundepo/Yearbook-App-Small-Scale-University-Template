...
late MechatronicsEngineeringNotifier mechatronicsEngineeringNotifier;
...
class MyMechatronicsEngineeringGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyMechatronicsEngineeringGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyMechatronicsEngineeringGraduatesDetailsPage> createState() => MyMechatronicsEngineeringGraduatesDetailsPageState();
}

class MyMechatronicsEngineeringGraduatesDetailsPageState extends State<MyMechatronicsEngineeringGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    mechatronicsEngineeringNotifier = Provider.of<MechatronicsEngineeringNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            mechatronicsEngineeringNotifier.currentMechatronicsEngineering.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: mechatronicsEngineeringNotifier.currentMechatronicsEngineering.image!,
                        fit: BoxFit.cover,
                  ...
                  message: mechatronicsEngineeringNotifier.currentMechatronicsEngineering.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              mechatronicsEngineeringNotifier.currentMechatronicsEngineering.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (mechatronicsEngineeringNotifier.currentMechatronicsEngineering.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    MechatronicsEngineeringNotifier mechatronicsEngineeringNotifier = Provider.of<MechatronicsEngineeringNotifier>(context, listen: false);

    _autoBio = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.autoBio;
    _bestMoment = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.bestMoment;
    _whyCourseOfStudy = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.whyCourseOfStudy;
    _highSchool = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.highSchool;
    _highSchoolGraduationYear = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.highSchoolGraduationYear;
    _linkedIn = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.linkedIn;
    _favouriteCourse = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.favouriteCourse;
    _schoolExecutive = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.schoolExecutive;
    _schoolExecutivePosition = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.schoolExecutivePosition;
    _snapchat = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.snapchat;
    _tikTok = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.tikTok;
    _favSchoolActivity = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.favSchoolActivity;
    _scpcExecutive = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.scpcExecutive;
    _scpcExecutivePosition = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.scpcExecutivePosition;
    _favouriteLocationOnCampus = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.favouriteLocationOnCampus;
    _favoriteSportOnCampus = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.favoriteSportOnCampus;
    _originState = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.stateOfOrigin;
    _whatsNext = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.whatsNext;
    _stateResiding = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.whereYouReside;
    _bestMoment = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.bestMoment;
    _dob = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.dob;
    _email = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.email;
    _facebook = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.facebook;
    _hobbies = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.hobbies;
    _instagram = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.instagram;
    _myDropline = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.myDropline;
    _name = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.name;
    _nickname = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.nickname!;
    _philosophy = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.philosophy;
    _phone = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.phone;
    _twitter = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.twitter;
    _worstMoment = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.worstMoment;
    _occupation = mechatronicsEngineeringNotifier.currentMechatronicsEngineering.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: mechatronicsEngineeringNotifier.currentMechatronicsEngineering.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
