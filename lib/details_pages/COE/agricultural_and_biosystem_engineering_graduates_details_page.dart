...
late AgriculturalAndBiosystemEngineeringNotifier agriculturalAndBiosystemEngineeringNotifier;
...
class MyAgriculturalAndBiosystemEngineeringGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyAgriculturalAndBiosystemEngineeringGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyAgriculturalAndBiosystemEngineeringGraduatesDetailsPage> createState() => MyAgriculturalAndBiosystemEngineeringGraduatesDetailsPageState();
}

class MyAgriculturalAndBiosystemEngineeringGraduatesDetailsPageState extends State<MyAgriculturalAndBiosystemEngineeringGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    agriculturalAndBiosystemEngineeringNotifier = Provider.of<AgriculturalAndBiosystemEngineeringNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.image!,
                        fit: BoxFit.cover,
                  ...
                  message: agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    AgriculturalAndBiosystemEngineeringNotifier agriculturalAndBiosystemEngineeringNotifier =
        Provider.of<AgriculturalAndBiosystemEngineeringNotifier>(context, listen: false);

    _autoBio = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.autoBio;
    _bestMoment = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.bestMoment;
    _whyCourseOfStudy = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.whyCourseOfStudy;
    _highSchool = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.highSchool;
    _highSchoolGraduationYear = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.highSchoolGraduationYear;
    _linkedIn = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.linkedIn;
    _favouriteCourse = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.favouriteCourse;
    _schoolExecutive = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.schoolExecutive;
    _schoolExecutivePosition = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.schoolExecutivePosition;
    _snapchat = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.snapchat;
    _tikTok = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.tikTok;
    _favSchoolActivity = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.favSchoolActivity;
    _scpcExecutive = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.scpcExecutive;
    _scpcExecutivePosition = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.scpcExecutivePosition;
    _favouriteLocationOnCampus = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.favouriteLocationOnCampus;
    _favoriteSportOnCampus = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.favoriteSportOnCampus;
    _originState = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.stateOfOrigin;
    _whatsNext = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.whatsNext;
    _stateResiding = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.whereYouReside;
    _bestMoment = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.bestMoment;
    _dob = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.dob;
    _email = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.email;
    _facebook = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.facebook;
    _hobbies = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.hobbies;
    _instagram = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.instagram;
    _myDropline = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.myDropline;
    _name = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.name;
    _nickname = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.nickname!;
    _philosophy = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.philosophy;
    _phone = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.phone;
    _twitter = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.twitter;
    _worstMoment = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.worstMoment;
    _occupation = agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
