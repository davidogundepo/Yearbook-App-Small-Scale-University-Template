...
late ChemicalEngineeringNotifier chemicalEngineeringNotifier;
...
class MyChemicalEngineeringGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyChemicalEngineeringGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyChemicalEngineeringGraduatesDetailsPage> createState() => MyChemicalEngineeringGraduatesDetailsPageState();
}

class MyChemicalEngineeringGraduatesDetailsPageState extends State<MyChemicalEngineeringGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    chemicalEngineeringNotifier = Provider.of<ChemicalEngineeringNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            chemicalEngineeringNotifier.currentChemicalEngineering.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: chemicalEngineeringNotifier.currentChemicalEngineering.image!,
                        fit: BoxFit.cover,
                  ...
                  message: chemicalEngineeringNotifier.currentChemicalEngineering.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              chemicalEngineeringNotifier.currentChemicalEngineering.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (chemicalEngineeringNotifier.currentChemicalEngineering.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    ChemicalEngineeringNotifier chemicalEngineeringNotifier = Provider.of<ChemicalEngineeringNotifier>(context, listen: false);

    _autoBio = chemicalEngineeringNotifier.currentChemicalEngineering.autoBio;
    _bestMoment = chemicalEngineeringNotifier.currentChemicalEngineering.bestMoment;
    _whyCourseOfStudy = chemicalEngineeringNotifier.currentChemicalEngineering.whyCourseOfStudy;
    _highSchool = chemicalEngineeringNotifier.currentChemicalEngineering.highSchool;
    _highSchoolGraduationYear = chemicalEngineeringNotifier.currentChemicalEngineering.highSchoolGraduationYear;
    _linkedIn = chemicalEngineeringNotifier.currentChemicalEngineering.linkedIn;
    _favouriteCourse = chemicalEngineeringNotifier.currentChemicalEngineering.favouriteCourse;
    _schoolExecutive = chemicalEngineeringNotifier.currentChemicalEngineering.schoolExecutive;
    _schoolExecutivePosition = chemicalEngineeringNotifier.currentChemicalEngineering.schoolExecutivePosition;
    _snapchat = chemicalEngineeringNotifier.currentChemicalEngineering.snapchat;
    _tikTok = chemicalEngineeringNotifier.currentChemicalEngineering.tikTok;
    _favSchoolActivity = chemicalEngineeringNotifier.currentChemicalEngineering.favSchoolActivity;
    _scpcExecutive = chemicalEngineeringNotifier.currentChemicalEngineering.scpcExecutive;
    _scpcExecutivePosition = chemicalEngineeringNotifier.currentChemicalEngineering.scpcExecutivePosition;
    _favouriteLocationOnCampus = chemicalEngineeringNotifier.currentChemicalEngineering.favouriteLocationOnCampus;
    _favoriteSportOnCampus = chemicalEngineeringNotifier.currentChemicalEngineering.favoriteSportOnCampus;
    _originState = chemicalEngineeringNotifier.currentChemicalEngineering.stateOfOrigin;
    _whatsNext = chemicalEngineeringNotifier.currentChemicalEngineering.whatsNext;
    _stateResiding = chemicalEngineeringNotifier.currentChemicalEngineering.whereYouReside;
    _bestMoment = chemicalEngineeringNotifier.currentChemicalEngineering.bestMoment;
    _dob = chemicalEngineeringNotifier.currentChemicalEngineering.dob;
    _email = chemicalEngineeringNotifier.currentChemicalEngineering.email;
    _facebook = chemicalEngineeringNotifier.currentChemicalEngineering.facebook;
    _hobbies = chemicalEngineeringNotifier.currentChemicalEngineering.hobbies;
    _instagram = chemicalEngineeringNotifier.currentChemicalEngineering.instagram;
    _myDropline = chemicalEngineeringNotifier.currentChemicalEngineering.myDropline;
    _name = chemicalEngineeringNotifier.currentChemicalEngineering.name;
    _nickname = chemicalEngineeringNotifier.currentChemicalEngineering.nickname!;
    _philosophy = chemicalEngineeringNotifier.currentChemicalEngineering.philosophy;
    _phone = chemicalEngineeringNotifier.currentChemicalEngineering.phone;
    _twitter = chemicalEngineeringNotifier.currentChemicalEngineering.twitter;
    _worstMoment = chemicalEngineeringNotifier.currentChemicalEngineering.worstMoment;
    _occupation = chemicalEngineeringNotifier.currentChemicalEngineering.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: chemicalEngineeringNotifier.currentChemicalEngineering.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
