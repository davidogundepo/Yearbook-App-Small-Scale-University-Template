...
late IndustrialMathematicsNotifier industrialMathematicsNotifier;
...
class MyIndustrialMathematicsGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyIndustrialMathematicsGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyIndustrialMathematicsGraduatesDetailsPage> createState() => MyIndustrialMathematicsGraduatesDetailsPageState();
}

class MyIndustrialMathematicsGraduatesDetailsPageState extends State<MyIndustrialMathematicsGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    industrialMathematicsNotifier = Provider.of<IndustrialMathematicsNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            industrialMathematicsNotifier.currentIndustrialMathematics.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: industrialMathematicsNotifier.currentIndustrialMathematics.image!,
                        fit: BoxFit.cover,
                  ...
                  message: industrialMathematicsNotifier.currentIndustrialMathematics.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              industrialMathematicsNotifier.currentIndustrialMathematics.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (industrialMathematicsNotifier.currentIndustrialMathematics.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    IndustrialMathematicsNotifier industrialMathematicsNotifier = Provider.of<IndustrialMathematicsNotifier>(context, listen: false);

    _autoBio = industrialMathematicsNotifier.currentIndustrialMathematics.autoBio;
    _bestMoment = industrialMathematicsNotifier.currentIndustrialMathematics.bestMoment;
    _whyCourseOfStudy = industrialMathematicsNotifier.currentIndustrialMathematics.whyCourseOfStudy;
    _highSchool = industrialMathematicsNotifier.currentIndustrialMathematics.highSchool;
    _highSchoolGraduationYear = industrialMathematicsNotifier.currentIndustrialMathematics.highSchoolGraduationYear;
    _linkedIn = industrialMathematicsNotifier.currentIndustrialMathematics.linkedIn;
    _favouriteCourse = industrialMathematicsNotifier.currentIndustrialMathematics.favouriteCourse;
    _schoolExecutive = industrialMathematicsNotifier.currentIndustrialMathematics.schoolExecutive;
    _schoolExecutivePosition = industrialMathematicsNotifier.currentIndustrialMathematics.schoolExecutivePosition;
    _snapchat = industrialMathematicsNotifier.currentIndustrialMathematics.snapchat;
    _tikTok = industrialMathematicsNotifier.currentIndustrialMathematics.tikTok;
    _favSchoolActivity = industrialMathematicsNotifier.currentIndustrialMathematics.favSchoolActivity;
    _scpcExecutive = industrialMathematicsNotifier.currentIndustrialMathematics.scpcExecutive;
    _scpcExecutivePosition = industrialMathematicsNotifier.currentIndustrialMathematics.scpcExecutivePosition;
    _favouriteLocationOnCampus = industrialMathematicsNotifier.currentIndustrialMathematics.favouriteLocationOnCampus;
    _favoriteSportOnCampus = industrialMathematicsNotifier.currentIndustrialMathematics.favoriteSportOnCampus;
    _originState = industrialMathematicsNotifier.currentIndustrialMathematics.stateOfOrigin;
    _whatsNext = industrialMathematicsNotifier.currentIndustrialMathematics.whatsNext;
    _stateResiding = industrialMathematicsNotifier.currentIndustrialMathematics.whereYouReside;
    _bestMoment = industrialMathematicsNotifier.currentIndustrialMathematics.bestMoment;
    _dob = industrialMathematicsNotifier.currentIndustrialMathematics.dob;
    _email = industrialMathematicsNotifier.currentIndustrialMathematics.email;
    _facebook = industrialMathematicsNotifier.currentIndustrialMathematics.facebook;
    _hobbies = industrialMathematicsNotifier.currentIndustrialMathematics.hobbies;
    _instagram = industrialMathematicsNotifier.currentIndustrialMathematics.instagram;
    _myDropline = industrialMathematicsNotifier.currentIndustrialMathematics.myDropline;
    _name = industrialMathematicsNotifier.currentIndustrialMathematics.name;
    _nickname = industrialMathematicsNotifier.currentIndustrialMathematics.nickname!;
    _philosophy = industrialMathematicsNotifier.currentIndustrialMathematics.philosophy;
    _phone = industrialMathematicsNotifier.currentIndustrialMathematics.phone;
    _twitter = industrialMathematicsNotifier.currentIndustrialMathematics.twitter;
    _worstMoment = industrialMathematicsNotifier.currentIndustrialMathematics.worstMoment;
    _occupation = industrialMathematicsNotifier.currentIndustrialMathematics.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: industrialMathematicsNotifier.currentIndustrialMathematics.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
