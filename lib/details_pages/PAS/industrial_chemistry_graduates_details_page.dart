...
late IndustrialChemistryNotifier industrialChemistryNotifier;
...
class MyIndustrialChemistryGraduatesDetailsPage extends StatefulWidget {
  ...
  const MyIndustrialChemistryGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyIndustrialChemistryGraduatesDetailsPage> createState() => MyIndustrialChemistryGraduatesDetailsPageState();
}

class MyIndustrialChemistryGraduatesDetailsPageState extends State<MyIndustrialChemistryGraduatesDetailsPage> {
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            industrialChemistryNotifier.currentIndustrialChemistry.nickname!,
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              industrialChemistryNotifier.currentIndustrialChemistry.name!.toUpperCase(),
  ...
  initState() {
    ...
    _favouriteCourse = industrialChemistryNotifier.currentIndustrialChemistry.favouriteCourse;
    ...
    _snapchat = industrialChemistryNotifier.currentIndustrialChemistry.snapchat;
    _tikTok = industrialChemistryNotifier.currentIndustrialChemistry.tikTok;
    _favSchoolActivity = industrialChemistryNotifier.currentIndustrialChemistry.favSchoolActivity;
    _scpcExecutive = industrialChemistryNotifier.currentIndustrialChemistry.scpcExecutive;
    _scpcExecutivePosition = industrialChemistryNotifier.currentIndustrialChemistry.scpcExecutivePosition;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: industrialChemistryNotifier.currentIndustrialChemistry.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
