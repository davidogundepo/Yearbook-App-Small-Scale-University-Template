...
late MicrobiologyNotifier microbiologyNotifier;
...
class MyMicrobiologyGraduatesDetailsPage extends StatefulWidget {
  ...
  const MyMicrobiologyGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyMicrobiologyGraduatesDetailsPage> createState() => MyMicrobiologyGraduatesDetailsPageState();
}

class MyMicrobiologyGraduatesDetailsPageState extends State<MyMicrobiologyGraduatesDetailsPage> {
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            microbiologyNotifier.currentMicrobiology.nickname!,
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              microbiologyNotifier.currentMicrobiology.name!.toUpperCase(),
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: microbiologyNotifier.currentMicrobiology.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
