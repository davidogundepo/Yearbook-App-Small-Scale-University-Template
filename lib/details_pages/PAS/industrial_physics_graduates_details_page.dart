...
late IndustrialPhysicsNotifier industrialPhysicsNotifier;
...
class MyIndustrialPhysicsGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyIndustrialPhysicsGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyIndustrialPhysicsGraduatesDetailsPage> createState() => MyIndustrialPhysicsGraduatesDetailsPageState();
}

class MyIndustrialPhysicsGraduatesDetailsPageState extends State<MyIndustrialPhysicsGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    industrialPhysicsNotifier = Provider.of<IndustrialPhysicsNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            industrialPhysicsNotifier.currentIndustrialPhysics.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: industrialPhysicsNotifier.currentIndustrialPhysics.image!,
                        fit: BoxFit.cover,
                  ...
                  message: industrialPhysicsNotifier.currentIndustrialPhysics.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              industrialPhysicsNotifier.currentIndustrialPhysics.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (industrialPhysicsNotifier.currentIndustrialPhysics.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    IndustrialPhysicsNotifier industrialPhysicsNotifier = Provider.of<IndustrialPhysicsNotifier>(context, listen: false);

    _autoBio = industrialPhysicsNotifier.currentIndustrialPhysics.autoBio;
    _bestMoment = industrialPhysicsNotifier.currentIndustrialPhysics.bestMoment;
    _whyCourseOfStudy = industrialPhysicsNotifier.currentIndustrialPhysics.whyCourseOfStudy;
    _highSchool = industrialPhysicsNotifier.currentIndustrialPhysics.highSchool;
    _highSchoolGraduationYear = industrialPhysicsNotifier.currentIndustrialPhysics.highSchoolGraduationYear;
    _linkedIn = industrialPhysicsNotifier.currentIndustrialPhysics.linkedIn;
    _favouriteCourse = industrialPhysicsNotifier.currentIndustrialPhysics.favouriteCourse;
    _schoolExecutive = industrialPhysicsNotifier.currentIndustrialPhysics.schoolExecutive;
    _schoolExecutivePosition = industrialPhysicsNotifier.currentIndustrialPhysics.schoolExecutivePosition;
    _snapchat = industrialPhysicsNotifier.currentIndustrialPhysics.snapchat;
    _tikTok = industrialPhysicsNotifier.currentIndustrialPhysics.tikTok;
    _favSchoolActivity = industrialPhysicsNotifier.currentIndustrialPhysics.favSchoolActivity;
    _scpcExecutive = industrialPhysicsNotifier.currentIndustrialPhysics.scpcExecutive;
    _scpcExecutivePosition = industrialPhysicsNotifier.currentIndustrialPhysics.scpcExecutivePosition;
    _favouriteLocationOnCampus;
    _favouriteLocationOnCampus = industrialPhysicsNotifier.currentIndustrialPhysics.favouriteLocationOnCampus;
    _favoriteSportOnCampus = industrialPhysicsNotifier.currentIndustrialPhysics.favoriteSportOnCampus;
    _originState = industrialPhysicsNotifier.currentIndustrialPhysics.stateOfOrigin;
    _whatsNext = industrialPhysicsNotifier.currentIndustrialPhysics.whatsNext;
    _stateResiding = industrialPhysicsNotifier.currentIndustrialPhysics.whereYouReside;
    _bestMoment = industrialPhysicsNotifier.currentIndustrialPhysics.bestMoment;
    _dob = industrialPhysicsNotifier.currentIndustrialPhysics.dob;
    _email = industrialPhysicsNotifier.currentIndustrialPhysics.email;
    _facebook = industrialPhysicsNotifier.currentIndustrialPhysics.facebook;
    _hobbies = industrialPhysicsNotifier.currentIndustrialPhysics.hobbies;
    _instagram = industrialPhysicsNotifier.currentIndustrialPhysics.instagram;
    _myDropline = industrialPhysicsNotifier.currentIndustrialPhysics.myDropline;
    _name = industrialPhysicsNotifier.currentIndustrialPhysics.name;
    _nickname = industrialPhysicsNotifier.currentIndustrialPhysics.nickname!;
    _philosophy = industrialPhysicsNotifier.currentIndustrialPhysics.philosophy;
    _phone = industrialPhysicsNotifier.currentIndustrialPhysics.phone;
    _twitter = industrialPhysicsNotifier.currentIndustrialPhysics.twitter;
    _worstMoment = industrialPhysicsNotifier.currentIndustrialPhysics.worstMoment;
    _occupation = industrialPhysicsNotifier.currentIndustrialPhysics.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: industrialPhysicsNotifier.currentIndustrialPhysics.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
