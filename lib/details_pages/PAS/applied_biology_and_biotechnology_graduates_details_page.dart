...
late AppliedBiologyAndBiotechnologyNotifier appliedBiologyAndBiotechnologyNotifier;
...
class MyAppliedBiologyAndBiotechnologyGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyAppliedBiologyAndBiotechnologyGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyAppliedBiologyAndBiotechnologyGraduatesDetailsPage> createState() => MyAppliedBiologyAndBiotechnologyGraduatesDetailsPageState();
}

class MyAppliedBiologyAndBiotechnologyGraduatesDetailsPageState extends State<MyAppliedBiologyAndBiotechnologyGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    appliedBiologyAndBiotechnologyNotifier = Provider.of<AppliedBiologyAndBiotechnologyNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.image!,
                        fit: BoxFit.cover,
                  ...
                  message: appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    AppliedBiologyAndBiotechnologyNotifier appliedBiologyAndBiotechnologyNotifier =
        Provider.of<AppliedBiologyAndBiotechnologyNotifier>(context, listen: false);

    _autoBio = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.autoBio;
    _bestMoment = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.bestMoment;
    _whyCourseOfStudy = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.whyCourseOfStudy;
    _highSchool = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.highSchool;
    _highSchoolGraduationYear = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.highSchoolGraduationYear;
    _linkedIn = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.linkedIn;
    _favouriteCourse = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.favouriteCourse;
    _schoolExecutive = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.schoolExecutive;
    _schoolExecutivePosition = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.schoolExecutivePosition;
    _snapchat = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.snapchat;
    _tikTok = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.tikTok;
    _favSchoolActivity = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.favSchoolActivity;
    _scpcExecutive = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.scpcExecutive;
    _scpcExecutivePosition = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.scpcExecutivePosition;
    _favouriteLocationOnCampus = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.favouriteLocationOnCampus;
    _favoriteSportOnCampus = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.favoriteSportOnCampus;
    _originState = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.stateOfOrigin;
    _whatsNext = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.whatsNext;
    _stateResiding = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.whereYouReside;
    _bestMoment = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.bestMoment;
    _dob = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.dob;
    _email = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.email;
    _facebook = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.facebook;
    _hobbies = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.hobbies;
    _instagram = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.instagram;
    _myDropline = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.myDropline;
    _name = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.name;
    _nickname = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.nickname!;
    _philosophy = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.philosophy;
    _phone = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.phone;
    _twitter = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.twitter;
    _worstMoment = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.worstMoment;
    _occupation = appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
