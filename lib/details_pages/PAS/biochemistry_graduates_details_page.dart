...
late BiochemistryNotifier biochemistryNotifier;
...
class MyBiochemistryGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyBiochemistryGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyBiochemistryGraduatesDetailsPage> createState() => MyBiochemistryGraduatesDetailsPageState();
}

class MyBiochemistryGraduatesDetailsPageState extends State<MyBiochemistryGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    biochemistryNotifier = Provider.of<BiochemistryNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            biochemistryNotifier.currentBiochemistry.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: biochemistryNotifier.currentBiochemistry.image!,
                        fit: BoxFit.cover,
                  ...
                  message: biochemistryNotifier.currentBiochemistry.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              biochemistryNotifier.currentBiochemistry.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (biochemistryNotifier.currentBiochemistry.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    _autoBio = biochemistryNotifier.currentBiochemistry.autoBio;
    _bestMoment = biochemistryNotifier.currentBiochemistry.bestMoment;
    _whyCourseOfStudy = biochemistryNotifier.currentBiochemistry.whyCourseOfStudy;
    _highSchool = biochemistryNotifier.currentBiochemistry.highSchool;
    _highSchoolGraduationYear = biochemistryNotifier.currentBiochemistry.highSchoolGraduationYear;
    _linkedIn = biochemistryNotifier.currentBiochemistry.linkedIn;
    _favouriteCourse = biochemistryNotifier.currentBiochemistry.favouriteCourse;
    _schoolExecutive = biochemistryNotifier.currentBiochemistry.schoolExecutive;
    _schoolExecutivePosition = biochemistryNotifier.currentBiochemistry.schoolExecutivePosition;
    _snapchat = biochemistryNotifier.currentBiochemistry.snapchat;
    _tikTok = biochemistryNotifier.currentBiochemistry.tikTok;
    _favSchoolActivity = biochemistryNotifier.currentBiochemistry.favSchoolActivity;
    _scpcExecutive = biochemistryNotifier.currentBiochemistry.scpcExecutive;
    _scpcExecutivePosition = biochemistryNotifier.currentBiochemistry.scpcExecutivePosition;
    _favouriteLocationOnCampus = biochemistryNotifier.currentBiochemistry.favouriteLocationOnCampus;
    _favoriteSportOnCampus = biochemistryNotifier.currentBiochemistry.favoriteSportOnCampus;
    _originState = biochemistryNotifier.currentBiochemistry.stateOfOrigin;
    _whatsNext = biochemistryNotifier.currentBiochemistry.whatsNext;
    _stateResiding = biochemistryNotifier.currentBiochemistry.whereYouReside;
    _bestMoment = biochemistryNotifier.currentBiochemistry.bestMoment;
    _dob = biochemistryNotifier.currentBiochemistry.dob;
    _email = biochemistryNotifier.currentBiochemistry.email;
    _facebook = biochemistryNotifier.currentBiochemistry.facebook;
    _hobbies = biochemistryNotifier.currentBiochemistry.hobbies;
    _instagram = biochemistryNotifier.currentBiochemistry.instagram;
    _myDropline = biochemistryNotifier.currentBiochemistry.myDropline;
    _name = biochemistryNotifier.currentBiochemistry.name;
    _nickname = biochemistryNotifier.currentBiochemistry.nickname!;
    _philosophy = biochemistryNotifier.currentBiochemistry.philosophy;
    _phone = biochemistryNotifier.currentBiochemistry.phone;
    _twitter = biochemistryNotifier.currentBiochemistry.twitter;
    _worstMoment = biochemistryNotifier.currentBiochemistry.worstMoment;
    _occupation = biochemistryNotifier.currentBiochemistry.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: biochemistryNotifier.currentBiochemistry.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
