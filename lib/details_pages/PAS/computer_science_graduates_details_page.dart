...
late ComputerScienceNotifier computerScienceNotifier;
...
class MyComputerScienceGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyComputerScienceGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyComputerScienceGraduatesDetailsPage> createState() => MyComputerScienceGraduatesDetailsPageState();
}

class MyComputerScienceGraduatesDetailsPageState extends State<MyComputerScienceGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    computerScienceNotifier = Provider.of<ComputerScienceNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            computerScienceNotifier.currentComputerScience.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: computerScienceNotifier.currentComputerScience.image!,
                        fit: BoxFit.cover,
                  ...
                  message: computerScienceNotifier.currentComputerScience.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              computerScienceNotifier.currentComputerScience.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (computerScienceNotifier.currentComputerScience.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    ComputerScienceNotifier computerScienceNotifier = Provider.of<ComputerScienceNotifier>(context, listen: false);

    _autoBio = computerScienceNotifier.currentComputerScience.autoBio;
    _bestMoment = computerScienceNotifier.currentComputerScience.bestMoment;
    _whyCourseOfStudy = computerScienceNotifier.currentComputerScience.whyCourseOfStudy;
    _highSchool = computerScienceNotifier.currentComputerScience.highSchool;
    _highSchoolGraduationYear = computerScienceNotifier.currentComputerScience.highSchoolGraduationYear;
    _linkedIn = computerScienceNotifier.currentComputerScience.linkedIn;
    _favouriteCourse = computerScienceNotifier.currentComputerScience.favouriteCourse;
    _schoolExecutive = computerScienceNotifier.currentComputerScience.schoolExecutive;
    _schoolExecutivePosition = computerScienceNotifier.currentComputerScience.schoolExecutivePosition;
    _snapchat = computerScienceNotifier.currentComputerScience.snapchat;
    _tikTok = computerScienceNotifier.currentComputerScience.tikTok;
    _favSchoolActivity = computerScienceNotifier.currentComputerScience.favSchoolActivity;
    _scpcExecutive = computerScienceNotifier.currentComputerScience.scpcExecutive;
    _scpcExecutivePosition = computerScienceNotifier.currentComputerScience.scpcExecutivePosition;
    _favouriteLocationOnCampus = computerScienceNotifier.currentComputerScience.favouriteLocationOnCampus;
    _favoriteSportOnCampus = computerScienceNotifier.currentComputerScience.favoriteSportOnCampus;
    _originState = computerScienceNotifier.currentComputerScience.stateOfOrigin;
    _whatsNext = computerScienceNotifier.currentComputerScience.whatsNext;
    _stateResiding = computerScienceNotifier.currentComputerScience.whereYouReside;
    _bestMoment = computerScienceNotifier.currentComputerScience.bestMoment;
    _dob = computerScienceNotifier.currentComputerScience.dob;
    _email = computerScienceNotifier.currentComputerScience.email;
    _facebook = computerScienceNotifier.currentComputerScience.facebook;
    _hobbies = computerScienceNotifier.currentComputerScience.hobbies;
    _instagram = computerScienceNotifier.currentComputerScience.instagram;
    _myDropline = computerScienceNotifier.currentComputerScience.myDropline;
    _name = computerScienceNotifier.currentComputerScience.name;
    _nickname = computerScienceNotifier.currentComputerScience.nickname!;
    _philosophy = computerScienceNotifier.currentComputerScience.philosophy;
    _phone = computerScienceNotifier.currentComputerScience.phone;
    _twitter = computerScienceNotifier.currentComputerScience.twitter;
    _worstMoment = computerScienceNotifier.currentComputerScience.worstMoment;
    _occupation = computerScienceNotifier.currentComputerScience.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: computerScienceNotifier.currentComputerScience.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
