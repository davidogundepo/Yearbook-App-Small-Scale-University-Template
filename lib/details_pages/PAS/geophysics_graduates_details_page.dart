...
late GeophysicsNotifier geophysicsNotifier;
...
class MyGeophysicsGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyGeophysicsGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyGeophysicsGraduatesDetailsPage> createState() => MyGeophysicsGraduatesDetailsPageState();
}

class MyGeophysicsGraduatesDetailsPageState extends State<MyGeophysicsGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    geophysicsNotifier = Provider.of<GeophysicsNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            geophysicsNotifier.currentGeophysics.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: geophysicsNotifier.currentGeophysics.image!,
                        fit: BoxFit.cover,
                  ...
                  message: geophysicsNotifier.currentGeophysics.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              geophysicsNotifier.currentGeophysics.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (geophysicsNotifier.currentGeophysics.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    GeophysicsNotifier geophysicsNotifier = Provider.of<GeophysicsNotifier>(context, listen: false);

    _autoBio = geophysicsNotifier.currentGeophysics.autoBio;
    _bestMoment = geophysicsNotifier.currentGeophysics.bestMoment;
    _whyCourseOfStudy = geophysicsNotifier.currentGeophysics.whyCourseOfStudy;
    _highSchool = geophysicsNotifier.currentGeophysics.highSchool;
    _highSchoolGraduationYear = geophysicsNotifier.currentGeophysics.highSchoolGraduationYear;
    _linkedIn = geophysicsNotifier.currentGeophysics.linkedIn;
    _favouriteCourse = geophysicsNotifier.currentGeophysics.favouriteCourse;
    _schoolExecutive = geophysicsNotifier.currentGeophysics.schoolExecutive;
    _schoolExecutivePosition = geophysicsNotifier.currentGeophysics.schoolExecutivePosition;
    _snapchat = geophysicsNotifier.currentGeophysics.snapchat;
    _tikTok = geophysicsNotifier.currentGeophysics.tikTok;
    _favSchoolActivity = geophysicsNotifier.currentGeophysics.favSchoolActivity;
    _scpcExecutive = geophysicsNotifier.currentGeophysics.scpcExecutive;
    _scpcExecutivePosition = geophysicsNotifier.currentGeophysics.scpcExecutivePosition;
    _favouriteLocationOnCampus = geophysicsNotifier.currentGeophysics.favouriteLocationOnCampus;
    _favoriteSportOnCampus = geophysicsNotifier.currentGeophysics.favoriteSportOnCampus;
    _originState = geophysicsNotifier.currentGeophysics.stateOfOrigin;
    _whatsNext = geophysicsNotifier.currentGeophysics.whatsNext;
    _stateResiding = geophysicsNotifier.currentGeophysics.whereYouReside;
    _bestMoment = geophysicsNotifier.currentGeophysics.bestMoment;
    _dob = geophysicsNotifier.currentGeophysics.dob;
    _email = geophysicsNotifier.currentGeophysics.email;
    _facebook = geophysicsNotifier.currentGeophysics.facebook;
    _hobbies = geophysicsNotifier.currentGeophysics.hobbies;
    _instagram = geophysicsNotifier.currentGeophysics.instagram;
    _myDropline = geophysicsNotifier.currentGeophysics.myDropline;
    _name = geophysicsNotifier.currentGeophysics.name;
    _nickname = geophysicsNotifier.currentGeophysics.nickname!;
    _philosophy = geophysicsNotifier.currentGeophysics.philosophy;
    _phone = geophysicsNotifier.currentGeophysics.phone;
    _twitter = geophysicsNotifier.currentGeophysics.twitter;
    _worstMoment = geophysicsNotifier.currentGeophysics.worstMoment;
    _occupation = geophysicsNotifier.currentGeophysics.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: geophysicsNotifier.currentGeophysics.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
