...
class MyManagementBodyDetailsPage extends StatefulWidget {
  ...
  MyManagementBodyDetailsPage({super.key, required this.clubId});

  @override
  State<MyManagementBodyDetailsPage> createState() => MyManagementBodyDetailsPageState();
}

class MyManagementBodyDetailsPageState extends State<MyManagementBodyDetailsPage> {
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        icon: Icon(MdiIcons.linkedin, color: iconTextColor),
                        label: Text(linkedInButton, style: GoogleFonts.abel(color: iconTextColor, fontSize: 18, fontWeight: FontWeight.w300)),
                        onPressed: () {
          ...
          (() {
            if (_autoBio.toString().isNotEmpty) {
              return Container(
                ...
                decoration: BoxDecoration(color: shapeDecorationColorTwo.withAlpha(50), borderRadius: new BorderRadius.circular(10)),
              );
            } else {
              return Visibility(
                  visible: !_isVisible,
