...
late AgriculturalEconomicsNotifier agriculturalEconomicsNotifier;
...
class MyAgriculturalEconomicsGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyAgriculturalEconomicsGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyAgriculturalEconomicsGraduatesDetailsPage> createState() => MyAgriculturalEconomicsGraduatesDetailsPageState();
}

class MyAgriculturalEconomicsGraduatesDetailsPageState extends State<MyAgriculturalEconomicsGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    agriculturalEconomicsNotifier = Provider.of<AgriculturalEconomicsNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            agriculturalEconomicsNotifier.currentAgriculturalEconomics.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: agriculturalEconomicsNotifier.currentAgriculturalEconomics.image!,
                        fit: BoxFit.cover,
                  ...
                  message: agriculturalEconomicsNotifier.currentAgriculturalEconomics.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              agriculturalEconomicsNotifier.currentAgriculturalEconomics.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (agriculturalEconomicsNotifier.currentAgriculturalEconomics.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    _autoBio = agriculturalEconomicsNotifier.currentAgriculturalEconomics.autoBio;
    _bestMoment = agriculturalEconomicsNotifier.currentAgriculturalEconomics.bestMoment;
    _whyCourseOfStudy = agriculturalEconomicsNotifier.currentAgriculturalEconomics.whyCourseOfStudy;
    ...
    _whatsNext = agriculturalEconomicsNotifier.currentAgriculturalEconomics.whatsNext;
    _stateResiding = agriculturalEconomicsNotifier.currentAgriculturalEconomics.whereYouReside;
    _bestMoment = agriculturalEconomicsNotifier.currentAgriculturalEconomics.bestMoment;
    _dob = agriculturalEconomicsNotifier.currentAgriculturalEconomics.dob;
    _email = agriculturalEconomicsNotifier.currentAgriculturalEconomics.email;
    _facebook = agriculturalEconomicsNotifier.currentAgriculturalEconomics.facebook;
    _hobbies = agriculturalEconomicsNotifier.currentAgriculturalEconomics.hobbies;
    _instagram = agriculturalEconomicsNotifier.currentAgriculturalEconomics.instagram;
    _myDropline = agriculturalEconomicsNotifier.currentAgriculturalEconomics.myDropline;
    _name = agriculturalEconomicsNotifier.currentAgriculturalEconomics.name;
    _nickname = agriculturalEconomicsNotifier.currentAgriculturalEconomics.nickname!;
    _philosophy = agriculturalEconomicsNotifier.currentAgriculturalEconomics.philosophy;
    _phone = agriculturalEconomicsNotifier.currentAgriculturalEconomics.phone;
    _twitter = agriculturalEconomicsNotifier.currentAgriculturalEconomics.twitter;
    _worstMoment = agriculturalEconomicsNotifier.currentAgriculturalEconomics.worstMoment;
    _occupation = agriculturalEconomicsNotifier.currentAgriculturalEconomics.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: agriculturalEconomicsNotifier.currentAgriculturalEconomics.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
