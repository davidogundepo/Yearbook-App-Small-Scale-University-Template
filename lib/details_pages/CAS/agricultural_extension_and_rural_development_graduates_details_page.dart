...
late AgriculturalExtensionAndRuralDevelopmentNotifier agriculturalExtensionAndRuralDevelopmentNotifier;
...
class MyAgriculturalExtensionAndRuralDevelopmentGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyAgriculturalExtensionAndRuralDevelopmentGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyAgriculturalExtensionAndRuralDevelopmentGraduatesDetailsPage> createState() =>
      MyAgriculturalExtensionAndRuralDevelopmentGraduatesDetailsPageState();
}

class MyAgriculturalExtensionAndRuralDevelopmentGraduatesDetailsPageState
    extends State<MyAgriculturalExtensionAndRuralDevelopmentGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    agriculturalExtensionAndRuralDevelopmentNotifier = Provider.of<AgriculturalExtensionAndRuralDevelopmentNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.image!,
                        fit: BoxFit.cover,
                  ...
                  message: agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.schoolExecutive ==
                                  "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
  ...
  initState() {
    ...
    AgriculturalExtensionAndRuralDevelopmentNotifier agriculturalExtensionAndRuralDevelopmentNotifier =
        Provider.of<AgriculturalExtensionAndRuralDevelopmentNotifier>(context, listen: false);

    _autoBio = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.autoBio;
    _bestMoment = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.bestMoment;
    _whyCourseOfStudy = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.whyCourseOfStudy;
    _highSchool = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.highSchool;
    _highSchoolGraduationYear =
        agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.highSchoolGraduationYear;
    _linkedIn = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.linkedIn;
    _favouriteCourse = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.favouriteCourse;
    _schoolExecutive = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.schoolExecutive;
    _schoolExecutivePosition =
        agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.schoolExecutivePosition;
    _snapchat = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.snapchat;
    _tikTok = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.tikTok;
    _favSchoolActivity = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.favSchoolActivity;
    ...
    _favouriteLocationOnCampus =
        agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.favouriteLocationOnCampus;
    ...
    _bestMoment = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.bestMoment;
    _dob = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.dob;
    _email = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.email;
    _facebook = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.facebook;
    _hobbies = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.hobbies;
    _instagram = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.instagram;
    _myDropline = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.myDropline;
    _name = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.name;
    _nickname = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.nickname!;
    _philosophy = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.philosophy;
    _phone = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.phone;
    _twitter = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.twitter;
    _worstMoment = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.worstMoment;
    _occupation = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
