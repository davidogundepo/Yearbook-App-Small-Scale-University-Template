...
class MyAgriculturalExtensionAndRuralDevelopmentGraduatesDetailsPage extends StatefulWidget {
  @override
  _MyAgriculturalExtensionAndRuralDevelopmentGraduatesDetailsPageState createState() => _MyAgriculturalExtensionAndRuralDevelopmentGraduatesDetailsPageState();
}

class _MyAgriculturalExtensionAndRuralDevelopmentGraduatesDetailsPageState extends State<MyAgriculturalExtensionAndRuralDevelopmentGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.nickname,
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.name.toUpperCase(),
                            ...
                            (() {
                              if (agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.schoolExecutive == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState(){
    ...
    AgriculturalExtensionAndRuralDevelopmentNotifier agriculturalExtensionAndRuralDevelopmentNotifier = Provider.of<AgriculturalExtensionAndRuralDevelopmentNotifier>(context, listen: false);
    ...
    _highSchoolGraduationYear = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.highSchoolGraduationYear;
    ...
    _schoolExecutivePosition = agriculturalExtensionAndRuralDevelopmentNotifier.currentAgriculturalExtensionAndRuralDevelopment.schoolExecutivePosition;
