...
late FoodScienceAndNutritionNotifier foodScienceAndNutritionNotifier;
...
class MyFoodScienceAndNutritionGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyFoodScienceAndNutritionGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyFoodScienceAndNutritionGraduatesDetailsPage> createState() => MyFoodScienceAndNutritionGraduatesDetailsPageState();
}

class MyFoodScienceAndNutritionGraduatesDetailsPageState extends State<MyFoodScienceAndNutritionGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    foodScienceAndNutritionNotifier = Provider.of<FoodScienceAndNutritionNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.image!,
                        fit: BoxFit.cover,
                  ...
                  message: foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    FoodScienceAndNutritionNotifier foodScienceAndNutritionNotifier = Provider.of<FoodScienceAndNutritionNotifier>(context, listen: false);

    _autoBio = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.autoBio;
    _bestMoment = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.bestMoment;
    _whyCourseOfStudy = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.whyCourseOfStudy;
    _highSchool = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.highSchool;
    _highSchoolGraduationYear = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.highSchoolGraduationYear;
    _linkedIn = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.linkedIn;
    _favouriteCourse = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.favouriteCourse;
    _schoolExecutive = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.schoolExecutive;
    _schoolExecutivePosition = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.schoolExecutivePosition;
    _snapchat = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.snapchat;
    _tikTok = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.tikTok;
    _favSchoolActivity = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.favSchoolActivity;
    _scpcExecutive = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.scpcExecutive;
    _scpcExecutivePosition = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.scpcExecutivePosition;
    _favouriteLocationOnCampus = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.favouriteLocationOnCampus;
    _favoriteSportOnCampus = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.favoriteSportOnCampus;
    _originState = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.stateOfOrigin;
    _whatsNext = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.whatsNext;
    _stateResiding = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.whereYouReside;
    _bestMoment = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.bestMoment;
    _dob = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.dob;
    _email = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.email;
    _facebook = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.facebook;
    _hobbies = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.hobbies;
    _instagram = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.instagram;
    _myDropline = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.myDropline;
    _name = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.name;
    _nickname = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.nickname!;
    _philosophy = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.philosophy;
    _phone = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.phone;
    _twitter = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.twitter;
    _worstMoment = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.worstMoment;
    _occupation = foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
