...
late AnimalScienceNotifier animalScienceNotifier;
...
class MyAnimalScienceGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyAnimalScienceGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyAnimalScienceGraduatesDetailsPage> createState() => MyAnimalScienceGraduatesDetailsPageState();
}

class MyAnimalScienceGraduatesDetailsPageState extends State<MyAnimalScienceGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    animalScienceNotifier = Provider.of<AnimalScienceNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            animalScienceNotifier.currentAnimalScience.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: animalScienceNotifier.currentAnimalScience.image!,
                        fit: BoxFit.cover,
                  ...
                  message: animalScienceNotifier.currentAnimalScience.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              animalScienceNotifier.currentAnimalScience.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (animalScienceNotifier.currentAnimalScience.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    _autoBio = animalScienceNotifier.currentAnimalScience.autoBio;
    _bestMoment = animalScienceNotifier.currentAnimalScience.bestMoment;
    _whyCourseOfStudy = animalScienceNotifier.currentAnimalScience.whyCourseOfStudy;
    _highSchool = animalScienceNotifier.currentAnimalScience.highSchool;
    _highSchoolGraduationYear = animalScienceNotifier.currentAnimalScience.highSchoolGraduationYear;
    _linkedIn = animalScienceNotifier.currentAnimalScience.linkedIn;
    _favouriteCourse = animalScienceNotifier.currentAnimalScience.favouriteCourse;
    _schoolExecutive = animalScienceNotifier.currentAnimalScience.schoolExecutive;
    _schoolExecutivePosition = animalScienceNotifier.currentAnimalScience.schoolExecutivePosition;
    _snapchat = animalScienceNotifier.currentAnimalScience.snapchat;
    _tikTok = animalScienceNotifier.currentAnimalScience.tikTok;
    _favSchoolActivity = animalScienceNotifier.currentAnimalScience.favSchoolActivity;
    _scpcExecutive = animalScienceNotifier.currentAnimalScience.scpcExecutive;
    _scpcExecutivePosition = animalScienceNotifier.currentAnimalScience.scpcExecutivePosition;
    _favouriteLocationOnCampus = animalScienceNotifier.currentAnimalScience.favouriteLocationOnCampus;
    _favoriteSportOnCampus = animalScienceNotifier.currentAnimalScience.favoriteSportOnCampus;
    _originState = animalScienceNotifier.currentAnimalScience.stateOfOrigin;
    _whatsNext = animalScienceNotifier.currentAnimalScience.whatsNext;
    _stateResiding = animalScienceNotifier.currentAnimalScience.whereYouReside;
    _bestMoment = animalScienceNotifier.currentAnimalScience.bestMoment;
    _dob = animalScienceNotifier.currentAnimalScience.dob;
    _email = animalScienceNotifier.currentAnimalScience.email;
    _facebook = animalScienceNotifier.currentAnimalScience.facebook;
    _hobbies = animalScienceNotifier.currentAnimalScience.hobbies;
    _instagram = animalScienceNotifier.currentAnimalScience.instagram;
    _myDropline = animalScienceNotifier.currentAnimalScience.myDropline;
    _name = animalScienceNotifier.currentAnimalScience.name;
    _nickname = animalScienceNotifier.currentAnimalScience.nickname!;
    _philosophy = animalScienceNotifier.currentAnimalScience.philosophy;
    _phone = animalScienceNotifier.currentAnimalScience.phone;
    _twitter = animalScienceNotifier.currentAnimalScience.twitter;
    _worstMoment = animalScienceNotifier.currentAnimalScience.worstMoment;
    _occupation = animalScienceNotifier.currentAnimalScience.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: animalScienceNotifier.currentAnimalScience.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
