...
late CropScienceAndSoilScienceNotifier cropScienceAndSoilScienceNotifier;
...
class MyCropScienceAndSoilScienceGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyCropScienceAndSoilScienceGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyCropScienceAndSoilScienceGraduatesDetailsPage> createState() => MyCropScienceAndSoilScienceGraduatesDetailsPageState();
}

class MyCropScienceAndSoilScienceGraduatesDetailsPageState extends State<MyCropScienceAndSoilScienceGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    cropScienceAndSoilScienceNotifier = Provider.of<CropScienceAndSoilScienceNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.image!,
                        fit: BoxFit.cover,
                  ...
                  message: cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    _autoBio = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.autoBio;
    _bestMoment = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.bestMoment;
    _whyCourseOfStudy = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.whyCourseOfStudy;
    _highSchool = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.highSchool;
    _highSchoolGraduationYear = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.highSchoolGraduationYear;
    _linkedIn = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.linkedIn;
    _favouriteCourse = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.favouriteCourse;
    _schoolExecutive = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.schoolExecutive;
    _schoolExecutivePosition = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.schoolExecutivePosition;
    _snapchat = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.snapchat;
    _tikTok = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.tikTok;
    _favSchoolActivity = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.favSchoolActivity;
    _scpcExecutive = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.scpcExecutive;
    _scpcExecutivePosition = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.scpcExecutivePosition;
    _favouriteLocationOnCampus = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.favouriteLocationOnCampus;
    _favoriteSportOnCampus = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.favoriteSportOnCampus;
    _originState = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.stateOfOrigin;
    _whatsNext = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.whatsNext;
    _stateResiding = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.whereYouReside;
    _bestMoment = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.bestMoment;
    _dob = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.dob;
    _email = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.email;
    _facebook = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.facebook;
    _hobbies = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.hobbies;
    _instagram = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.instagram;
    _myDropline = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.myDropline;
    _name = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.name;
    _nickname = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.nickname!;
    _philosophy = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.philosophy;
    _phone = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.phone;
    _twitter = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.twitter;
    _worstMoment = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.worstMoment;
    _occupation = cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
