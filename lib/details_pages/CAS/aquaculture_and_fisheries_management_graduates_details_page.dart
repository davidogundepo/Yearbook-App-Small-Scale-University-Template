...
late AquacultureAndFisheriesManagementNotifier aquacultureAndFisheriesManagementNotifier;
...
class MyAquacultureAndFisheriesManagementGraduatesDetailsPage extends StatefulWidget {
  final String clubId;

  const MyAquacultureAndFisheriesManagementGraduatesDetailsPage({super.key, required this.clubId});
  @override
  State<MyAquacultureAndFisheriesManagementGraduatesDetailsPage> createState() => MyAquacultureAndFisheriesManagementGraduatesDetailsPageState();
}

class MyAquacultureAndFisheriesManagementGraduatesDetailsPageState extends State<MyAquacultureAndFisheriesManagementGraduatesDetailsPage> {
  ...
  Widget build(BuildContext context) {
    aquacultureAndFisheriesManagementNotifier = Provider.of<AquacultureAndFisheriesManagementNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(
            aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.nickname!,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.image!,
                        fit: BoxFit.cover,
                  ...
                  message: aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.name!.toUpperCase(),
                              style: GoogleFonts.blinker(color: shapeDecorationTextColor, fontSize: 30, fontWeight: FontWeight.w500),
                            ),
                            (() {
                              if (aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.schoolExecutive == "Yes") {
                                return Row(
                                  children: <Widget>[
                                    SizedBox(width: 10),
                                    Icon(
  ...
  initState() {
    ...
    AquacultureAndFisheriesManagementNotifier aquacultureAndFisheriesManagementNotifier =
        Provider.of<AquacultureAndFisheriesManagementNotifier>(context, listen: false);

    _autoBio = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.autoBio;
    _bestMoment = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.bestMoment;
    _whyCourseOfStudy = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.whyCourseOfStudy;
    _highSchool = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.highSchool;
    _highSchoolGraduationYear = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.highSchoolGraduationYear;
    _linkedIn = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.linkedIn;
    _favouriteCourse = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.favouriteCourse;
    _schoolExecutive = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.schoolExecutive;
    _schoolExecutivePosition = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.schoolExecutivePosition;
    _snapchat = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.snapchat;
    _tikTok = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.tikTok;
    _favSchoolActivity = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.favSchoolActivity;
    _scpcExecutive = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.scpcExecutive;
    _scpcExecutivePosition = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.scpcExecutivePosition;
    _favouriteLocationOnCampus = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.favouriteLocationOnCampus;
    _favoriteSportOnCampus = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.favoriteSportOnCampus;
    _originState = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.stateOfOrigin;
    _whatsNext = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.whatsNext;
    _stateResiding = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.whereYouReside;
    _bestMoment = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.bestMoment;
    _dob = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.dob;
    _email = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.email;
    _facebook = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.facebook;
    _hobbies = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.hobbies;
    _instagram = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.instagram;
    _myDropline = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.myDropline;
    _name = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.name;
    _nickname = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.nickname!;
    _philosophy = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.philosophy;
    _phone = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.phone;
    _twitter = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.twitter;
    _worstMoment = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.worstMoment;
    _occupation = aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.occupation;
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: _imageTwo != null
                            ...
                            : CachedNetworkImage(
                                imageUrl: aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement.imageTwo!,
                                fit: BoxFit.cover,
                                placeholder: (context, url) => const CircularProgressIndicator(),
                                errorWidget: (context, url, error) => Icon(MdiIcons.alertRhombus),
                              ),
