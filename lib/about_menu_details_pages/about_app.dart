...
String blemish =
    '"Do not be concerned about the blemishes and imperfections you may notice on the software, it is those blemishes that prove that the yearbook is authentic. :)"';
String copyrightTerms =
    "This software is subject to copyright of ICDAT dans le monde limited. Hence should not be developed or replicated without due permission by any company or individual.";
...
String termsEtConditions2 =
    "$schoolAlmanac and/or her subsidiaries are the owners or the licensee of the materials published on this software, and are at freewill by this permission to share with her stakeholders, parents, staff and students.";
...
String contactUs1 =
    "If you have any questions or suggestions about our Terms and Conditions, Disclaimer, Privacy Policy, Software do not hesitate to send an email by clicking me.";
...
class AboutAppDetails extends StatefulWidget {
  AboutAppDetails({super.key, this.title});
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(fontSize: 20, fontStyle: FontStyle.italic, color: headingCardTextColor, fontWeight: FontWeight.w700),
                            ),
                          ),
                        ),
                      ),
