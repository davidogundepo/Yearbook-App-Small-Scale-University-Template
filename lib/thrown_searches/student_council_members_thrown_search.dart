...
class MyStudentCouncilMembersSearch extends SearchDelegate {
  ...
  MyStudentCouncilMembersSearch({required this.clubId, required this.all});
  ...
  Future navigateToStudentCouncilMembersSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyStudentCouncilMembersDetailsPage(clubId: clubId)));
  }
