...
class MyIndustrialMathematicsGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyIndustrialMathematicsGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToIndustrialMathematicsGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyIndustrialMathematicsGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          industrialMathematicsNotifier.currentIndustrialMathematics = search[position];
                          navigateToIndustrialMathematicsGraduatesSearchDetailsPage(context);
                        },
