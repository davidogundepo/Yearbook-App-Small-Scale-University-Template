...
class MyComputerScienceGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyComputerScienceGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToComputerScienceGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyComputerScienceGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          computerScienceNotifier.currentComputerScience = search[position];
                          navigateToComputerScienceGraduatesSearchDetailsPage(context);
                        },
