...
class MyBiochemistryGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyBiochemistryGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToBiochemistryGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyBiochemistryGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          biochemistryNotifier.currentBiochemistry = search[position];
                          navigateToBiochemistryGraduatesSearchDetailsPage(context);
                        },
