...
class MyAppliedBiologyAndBiotechnologyGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyAppliedBiologyAndBiotechnologyGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToAppliedBiologyAndBiotechnologyGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyAppliedBiologyAndBiotechnologyGraduatesDetailsPage(clubId: clubId)));
  }
          ...
          child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int position) {
                AppliedBiologyAndBiotechnologyNotifier appliedBiologyAndBiotechnologyNotifier =
                    Provider.of<AppliedBiologyAndBiotechnologyNotifier>(context);
                return Padding(
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          appliedBiologyAndBiotechnologyNotifier.currentAppliedBiologyAndBiotechnology = search[position];
                          navigateToAppliedBiologyAndBiotechnologyGraduatesSearchDetailsPage(context);
                        },
