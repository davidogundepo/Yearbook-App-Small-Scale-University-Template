...
class MyIndustrialChemistryGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyIndustrialChemistryGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToIndustrialChemistryGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyIndustrialChemistryGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          industrialChemistryNotifier.currentIndustrialChemistry = search[position];
                          navigateToIndustrialChemistryGraduatesSearchDetailsPage(context);
                        },
