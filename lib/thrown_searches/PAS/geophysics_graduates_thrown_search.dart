...
class MyGeophysicsGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyGeophysicsGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToGeophysicsGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyGeophysicsGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          geophysicsNotifier.currentGeophysics = search[position];
                          navigateToGeophysicsGraduatesSearchDetailsPage(context);
                        },
