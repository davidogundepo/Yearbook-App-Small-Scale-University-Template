...
class MyIndustrialPhysicsGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyIndustrialPhysicsGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToIndustrialPhysicsGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyIndustrialPhysicsGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          industrialPhysicsNotifier.currentIndustrialPhysics = search[position];
                          navigateToIndustrialPhysicsGraduatesSearchDetailsPage(context);
                        },
