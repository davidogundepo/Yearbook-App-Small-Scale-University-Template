...
class MyMicrobiologyGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyMicrobiologyGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToMicrobiologyGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyMicrobiologyGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          microbiologyNotifier.currentMicrobiology = search[position];
                          navigateToMicrobiologyGraduatesSearchDetailsPage(context);
                        },
