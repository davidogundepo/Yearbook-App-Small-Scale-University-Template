...
class MyMechatronicsEngineeringGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyMechatronicsEngineeringGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToMechatronicsEngineeringGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyMechatronicsEngineeringGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          mechatronicsEngineeringNotifier.currentMechatronicsEngineering = search[position];
                          navigateToMechatronicsEngineeringGraduatesSearchDetailsPage(context);
                        },
