...
class MyElectricalAndInformationEngineeringGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyElectricalAndInformationEngineeringGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToElectricalAndInformationEngineeringGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyElectricalAndInformationEngineeringGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          electricalAndInformationEngineeringNotifier.currentElectricalAndInformationEngineering = search[position];
                          navigateToElectricalAndInformationEngineeringGraduatesSearchDetailsPage(context);
                        },
