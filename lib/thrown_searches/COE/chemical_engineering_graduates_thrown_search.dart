...
class MyChemicalEngineeringGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyChemicalEngineeringGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToChemicalEngineeringGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyChemicalEngineeringGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          chemicalEngineeringNotifier.currentChemicalEngineering = search[position];
                          navigateToChemicalEngineeringGraduatesSearchDetailsPage(context);
                        },
