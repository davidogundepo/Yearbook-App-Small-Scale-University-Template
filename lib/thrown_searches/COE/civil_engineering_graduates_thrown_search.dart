...
class MyCivilEngineeringGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyCivilEngineeringGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToCivilEngineeringGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyCivilEngineeringGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          civilEngineeringNotifier.currentCivilEngineering = search[position];
                          navigateToCivilEngineeringGraduatesSearchDetailsPage(context);
                        },
