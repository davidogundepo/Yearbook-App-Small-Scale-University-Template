...
class MyAgriculturalAndBiosystemEngineeringGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyAgriculturalAndBiosystemEngineeringGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToAgriculturalAndBiosystemEngineeringGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyAgriculturalAndBiosystemEngineeringGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          agriculturalAndBiosystemEngineeringNotifier.currentAgriculturalAndBiosystemEngineering = search[position];
                          navigateToAgriculturalAndBiosystemEngineeringGraduatesSearchDetailsPage(context);
                        },
