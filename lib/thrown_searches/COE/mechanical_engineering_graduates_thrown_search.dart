...
class MyMechanicalEngineeringGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyMechanicalEngineeringGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToMechanicalEngineeringGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyMechanicalEngineeringGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          mechanicalEngineeringNotifier.currentMechanicalEngineering = search[position];
                          navigateToMechanicalEngineeringGraduatesSearchDetailsPage(context);
                        },
