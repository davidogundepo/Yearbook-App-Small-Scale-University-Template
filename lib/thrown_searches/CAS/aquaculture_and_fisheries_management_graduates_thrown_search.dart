...
class MyAquacultureAndFisheriesManagementGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyAquacultureAndFisheriesManagementGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToAquacultureAndFisheriesManagementGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyAquacultureAndFisheriesManagementGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          aquacultureAndFisheriesManagementNotifier.currentAquacultureAndFisheriesManagement = search[position];
                          navigateToAquacultureAndFisheriesManagementGraduatesSearchDetailsPage(context);
                        },
