...
class MyFoodScienceAndNutritionGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyFoodScienceAndNutritionGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToFoodScienceAndNutritionGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyFoodScienceAndNutritionGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          foodScienceAndNutritionNotifier.currentFoodScienceAndNutrition = search[position];
                          navigateToFoodScienceAndNutritionGraduatesSearchDetailsPage(context);
                        },
