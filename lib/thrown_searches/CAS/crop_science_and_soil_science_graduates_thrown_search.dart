...
class MyCropScienceAndSoilScienceGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyCropScienceAndSoilScienceGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToCropScienceAndSoilScienceGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyCropScienceAndSoilScienceGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          cropScienceAndSoilScienceNotifier.currentCropScienceAndSoilScience = search[position];
                          navigateToCropScienceAndSoilScienceGraduatesSearchDetailsPage(context);
                        },
