...
class MyAgriculturalEconomicsGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyAgriculturalEconomicsGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToAgriculturalEconomicsGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyAgriculturalEconomicsGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          agriculturalEconomicsNotifier.currentAgriculturalEconomics = search[position];
                          navigateToAgriculturalEconomicsGraduatesSearchDetailsPage(context);
                        },
