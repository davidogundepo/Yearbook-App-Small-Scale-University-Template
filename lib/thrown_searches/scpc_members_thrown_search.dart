...
Color appBarBackgroundColor = Colors.blueGrey;
Color appBarIconColor = Colors.white;
Color modalColor = Color.fromRGBO(123, 176, 182, 1);
...
Color dialogBackgroundColor = Colors.blueGrey;
Color borderColor = Colors.black;
Color textHighlightColor = Colors.white;

var queryTech;

class MySCPCMembersSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MySCPCMembersSearch({required this.clubId, required this.all});
  ...
  Future navigateToSCPCMembersSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MySCPCMembersDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          scpcMembersNotifier.currentSCPCMembers = search[position];
                          navigateToSCPCMembersSearchDetailsPage(context);
                        },
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Text(search[position].positionEnforced,
