...
class MyPoliticalScienceGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyPoliticalScienceGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToPoliticalScienceGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyPoliticalScienceGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          politicalScienceNotifier.currentPoliticalScience = search[position];
                          navigateToPoliticalScienceGraduatesSearchDetailsPage(context);
                        },
