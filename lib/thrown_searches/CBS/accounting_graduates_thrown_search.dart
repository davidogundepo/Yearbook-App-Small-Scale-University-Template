...
class MyAccountingGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyAccountingGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToAccountingGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyAccountingGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          accountingNotifier.currentAccounting = search[position];
                          navigateToAccountingGraduatesSearchDetailsPage(context);
                        },
