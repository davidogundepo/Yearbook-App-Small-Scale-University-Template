...
class MyMassCommunicationsGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyMassCommunicationsGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToMassCommunicationsGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyMassCommunicationsGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          massCommunicationsNotifier.currentMassCommunications = search[position];
                          navigateToMassCommunicationsGraduatesSearchDetailsPage(context);
                        },
