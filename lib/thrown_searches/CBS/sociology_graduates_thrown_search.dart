...
class MySociologyGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MySociologyGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToSociologyGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MySociologyGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          sociologyNotifier.currentSociology = search[position];
                          navigateToSociologyGraduatesSearchDetailsPage(context);
                        },
