...
class MyBankingAndFinanceGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyBankingAndFinanceGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToBankingAndFinanceGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyBankingAndFinanceGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          bankingAndFinanceNotifier.currentBankingAndFinance = search[position];
                          navigateToBankingAndFinanceGraduatesSearchDetailsPage(context);
                        },
