...
class MyEconomicsGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyEconomicsGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToEconomicsGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyEconomicsGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          economicsNotifier.currentEconomics = search[position];
                          navigateToEconomicsGraduatesSearchDetailsPage(context);
                        },
