...
class MyBusinessAdministrationGraduatesSearch extends SearchDelegate {
  final List all;
  final String clubId;

  bool _isVisible = true;

  MyBusinessAdministrationGraduatesSearch({required this.clubId, required this.all});
  ...
  Future navigateToBusinessAdministrationGraduatesSearchDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyBusinessAdministrationGraduatesDetailsPage(clubId: clubId)));
  }
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          businessAdministrationNotifier.currentBusinessAdministration = search[position];
                          navigateToBusinessAdministrationGraduatesSearchDetailsPage(context);
                        },
