...
class MyBankingAndFinanceGraduatesPage extends StatefulWidget with NavigationStates {
  @override
  _MyBankingAndFinanceGraduatesPageState createState() => _MyBankingAndFinanceGraduatesPageState();
}

class _MyBankingAndFinanceGraduatesPageState extends State<MyBankingAndFinanceGraduatesPage> {
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            ...
                            image: CachedNetworkImageProvider(
                                bankingAndFinanceNotifier.bankingAndFinanceList[index].image
                            ),
                            fit: BoxFit.cover
                        )
                    ),
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              Text(
                                  bankingAndFinanceNotifier.bankingAndFinanceList[index].name,
                          ...
                          if (bankingAndFinanceNotifier.bankingAndFinanceList[index].twitter.toString().isNotEmpty) {
                            if (!bankingAndFinanceNotifier.bankingAndFinanceList[index].twitter.toString().contains("@")) {
                              return Padding(
                                ...
                                child: Text(
                                    bankingAndFinanceNotifier.bankingAndFinanceList[index].twitter == bankingAndFinanceNotifier.bankingAndFinanceList[index].twitter ? '@'+bankingAndFinanceNotifier.bankingAndFinanceList[index].twitter : bankingAndFinanceNotifier.bankingAndFinanceList[index].twitter,
  ...
  Future navigateToBankingAndFinanceDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyBankingAndFinanceGraduatesDetailsPage()));
  }
  ...
  void initState() {
    ...
    getBankingAndFinance(bankingAndFinanceNotifier);
                  ...
                  actions: <Widget>[
                    ...
                    IconButton(
                      ...
                      onPressed: bankingAndFinanceNotifier.bankingAndFinanceList == null
                        ...
                        showSearch(
                          context: context,
                          delegate: MyBankingAndFinanceGraduatesSearch(all: bankingAndFinanceNotifier.bankingAndFinanceList),
                        );
                      },
                      tooltip: "Search",
                    ),
