...
class MyInternationalRelationsGraduatesPage extends StatefulWidget implements NavigationStates {
  final String clubId;

  const MyInternationalRelationsGraduatesPage({super.key, required this.clubId});

  @override
  State<MyInternationalRelationsGraduatesPage> createState() => MyInternationalRelationsGraduatesPageState();
}

class MyInternationalRelationsGraduatesPageState extends State<MyInternationalRelationsGraduatesPage> {
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            ...
                            image: CachedNetworkImageProvider(internationalRelationsNotifier.internationalRelationsList[index].image!),
                            fit: BoxFit.cover)),
                  ),
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              Text(internationalRelationsNotifier.internationalRelationsList[index].name!,
                        ...
                        (() {
                          if (internationalRelationsNotifier.internationalRelationsList[index].twitter!.toString().isNotEmpty) {
                            if (!internationalRelationsNotifier.internationalRelationsList[index].twitter!.toString().contains("@")) {
                              ...
                              return Padding(
                                padding: const EdgeInsets.only(top: 10),
                                child: Text(internationalRelationsNotifier.internationalRelationsList[index].twitter!,
                                    style: GoogleFonts.varela(color: textColorTwo, fontStyle: FontStyle.italic)),
                              );
                            }
                          } else {
  ...
  Future navigateToInternationalRelationsDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyInternationalRelationsGraduatesDetailsPage(clubId: widget.clubId)));
  }
  ...
  void initState() {
    ...
    getInternationalRelations(internationalRelationsNotifier, widget.clubId);
                    ...
                    IconButton(
                      ...
                      onPressed: internationalRelationsNotifier.internationalRelationsList == null
                          ...
                          : () {
                              showSearch(
                                context: context,
                                delegate: MyInternationalRelationsGraduatesSearch(
                                    all: internationalRelationsNotifier.internationalRelationsList, clubId: widget.clubId),
                              );
                            },
                      tooltip: "Search",
                    ),
