...
String thrownName = "Student Council Members";
...
class MyStudentCouncilMembersPage extends StatefulWidget implements NavigationStates {
  final String clubId;

  const MyStudentCouncilMembersPage({super.key, required this.clubId});

  @override
  State<MyStudentCouncilMembersPage> createState() => MyStudentCouncilMembersPageState();
}

class MyStudentCouncilMembersPageState extends State<MyStudentCouncilMembersPage> {
      ...
      child: Container(
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            onTap: () {
              studentCouncilMembersNotifier.currentStudentCouncilMembers = studentCouncilMembersNotifier.studentCouncilMembersList[index];
              navigateToStudentCouncilMembersDetailsPage(context);
            },
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            ...
                            image: CachedNetworkImageProvider(studentCouncilMembersNotifier.studentCouncilMembersList[index].image!),
                            fit: BoxFit.cover)),
                  ),
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              Text(studentCouncilMembersNotifier.studentCouncilMembersList[index].name!,
                        ...
                        Padding(
                          ...
                          child: Text(studentCouncilMembersNotifier.studentCouncilMembersList[index].positionEnforced!,
  ...
  Future navigateToStudentCouncilMembersDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyStudentCouncilMembersDetailsPage(clubId: widget.clubId)));
  }
  ...
  @override
  void initState() {
    StudentCouncilMembersNotifier studentCouncilMembersNotifier = Provider.of<StudentCouncilMembersNotifier>(context, listen: false);
    getStudentCouncilMembers(studentCouncilMembersNotifier, widget.clubId);
    super.initState();
  }
                ...
                SliverAppBar(
                  actions: <Widget>[
                    ...
                    IconButton(
                      ...
                      onPressed: studentCouncilMembersNotifier.studentCouncilMembersList == null
                          ? null
                          : () {
                              showSearch(
                                context: context,
                                delegate: MyStudentCouncilMembersSearch(
                                    all: studentCouncilMembersNotifier.studentCouncilMembersList, clubId: widget.clubId),
                              );
                            },
                      tooltip: "Search",
                    ),
            ...
            body: Padding(
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: studentCouncilMembersNotifier.studentCouncilMembersList.length,
                ),
              ),
            ),
          ),
