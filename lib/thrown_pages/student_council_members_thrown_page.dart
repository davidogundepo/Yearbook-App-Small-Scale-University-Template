...
class MyStudentCouncilMembersPage extends StatefulWidget with NavigationStates {
  @override
  _MyStudentCouncilMembersPageState createState() => _MyStudentCouncilMembersPageState();
}

class _MyStudentCouncilMembersPageState extends State<MyStudentCouncilMembersPage> {
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            ...
                            image: CachedNetworkImageProvider(
                                studentCouncilMembersNotifier.studentCouncilMembersList[index].image
                            ),
                            fit: BoxFit.cover
                        )
                    ),
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              Text(
                                  studentCouncilMembersNotifier.studentCouncilMembersList[index].name,
                        ...
                        Padding(
                          ...
                          child: Text(
                              studentCouncilMembersNotifier.studentCouncilMembersList[index].positionEnforced,
                              style: GoogleFonts.tenorSans(
                                  color: textColor,
                                  fontSize: 16,
  ...
  void initState() {
    ...
    getStudentCouncilMembers(studentCouncilMembersNotifier);
    super.initState();
  }
                  ...
                  actions: <Widget>[
                    ...
                    IconButton(
                      ...
                      onPressed: studentCouncilMembersNotifier.studentCouncilMembersList == null
                        ...
                        showSearch(
                          context: context,
                          delegate: MyStudentCouncilMembersSearch(all: studentCouncilMembersNotifier.studentCouncilMembersList),
                        );
                      },
                      tooltip: "Search",
                    ),
