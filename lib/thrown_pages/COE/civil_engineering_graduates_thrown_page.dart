...
class MyCivilEngineeringGraduatesPage extends StatefulWidget implements NavigationStates {
  final String clubId;

  const MyCivilEngineeringGraduatesPage({super.key, required this.clubId});

  @override
  State<MyCivilEngineeringGraduatesPage> createState() => MyCivilEngineeringGraduatesPageState();
}

class MyCivilEngineeringGraduatesPageState extends State<MyCivilEngineeringGraduatesPage> {
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            ...
                            image: CachedNetworkImageProvider(civilEngineeringNotifier.civilEngineeringList[index].image!),
                            fit: BoxFit.cover)),
                  ),
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              Text(civilEngineeringNotifier.civilEngineeringList[index].name!,
                        ...
                        (() {
                          if (civilEngineeringNotifier.civilEngineeringList[index].twitter!.toString().isNotEmpty) {
                            if (!civilEngineeringNotifier.civilEngineeringList[index].twitter!.toString().contains("@")) {
                              ...
                              return Padding(
                                padding: const EdgeInsets.only(top: 10),
                                child: Text(civilEngineeringNotifier.civilEngineeringList[index].twitter!,
                                    style: GoogleFonts.varela(color: textColorTwo, fontStyle: FontStyle.italic)),
                              );
                            }
                          } else {
  ...
  Future navigateToCivilEngineeringDetailsPage(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => MyCivilEngineeringGraduatesDetailsPage(clubId: widget.clubId)));
  }
  ...
  void initState() {
    ...
    getCivilEngineering(civilEngineeringNotifier, widget.clubId);
                      ...
                      onPressed: civilEngineeringNotifier.civilEngineeringList == null
                          ...
                          : () {
                              showSearch(
                                context: context,
                                delegate:
                                    MyCivilEngineeringGraduatesSearch(all: civilEngineeringNotifier.civilEngineeringList, clubId: widget.clubId),
                              );
                            },
                      tooltip: "Search",
                    ),
